...
static struct ocelot_match_data lan9645x_desc = {
	.desc = {
...
static const struct of_device_id ocelot_pinctrl_of_match[] = {
	...
	{ .compatible = "microchip,lan969x-pinctrl", .data = &lan969x_desc },
	{ .compatible = "microchip,lan9645x-pinctrl", .data = &lan9645x_desc },
	{},
};
