...
const unsigned int lan969x_rcnt[RCNT_LAST] = {
	...
	[RC_VOP_LOC_PERIOD_CFG] = 27,
};

const unsigned int lan969x_gaddr[GADDR_LAST] = {
	[GA_AFI_MISC] = 25368,
	[GA_AFI_FRM_TBL] = 16384,
	[GA_AFI_DTI_MISC] = 25400,
	[GA_AFI_TTI_TICKS] = 25592,
	[GA_AFI_TTI_MISC] = 25636,
	[GA_AFI_PORT_TBL] = 25088,
	[GA_ANA_AC_RAM_CTRL] = 202000,
	[GA_ANA_AC_PS_COMMON] = 202880,
	[GA_ANA_AC_MIRROR_PROBE] = 203232,
	[GA_ANA_AC_AGGR] = 202240,
	...
	[GA_ANA_AC_STAT_GLOBAL_CFG_BUM] = 203716,
	[GA_ANA_AC_STAT_CNT_CFG_BUM] = 155648,
	...
	[GA_PORT_CONF_USXGMII_CFG] = 72,
	[GA_PORT_CONF_USXGMII_STAT] = 192,
	[GA_PTP_PTP_CFG] = 512,
...
const unsigned int lan969x_gcnt[GCNT_LAST] = {
	...
	[GC_PORT_CONF_USXGMII_CFG] = 10,
	[GC_PORT_CONF_USXGMII_STAT] = 10,
	[GC_PTP_PTP_PINS] = 8,
	[GC_PTP_PHASE_DETECTOR_CTRL] = 8,
	[GC_REW_PORT] = 35,
	[GC_REW_VMID] = 127,
	[GC_REW_VOE_PORT_LM_CNT] = 240,
	[GC_VOP_VOE_CONF_REG] = 62,
};
...
const unsigned int lan969x_fsize[FSIZE_LAST] = {
	[FW_AFI_NEW_FRM_INFO_FRM_INFO] = 24,
	[FW_AFI_FRM_NXT_AND_TYPE_NEXT_PTR] = 9,
	[FW_AFI_TTI_PORT_QU_PORT_NUM] = 6,
	[FW_AFI_TTI_PORT_QU_QU_NUM] = 14,
	[FW_AFI_TTI_FRM_FRM_PTR] = 9,
	...
	[FW_ANA_AC_POL_POL_ACL_RATE_CFG_ACL_RATE] = 19,
	[FW_ANA_AC_POL_POL_ACL_CTRL_ACL_PIPELINE_PT] = 5,
	[FW_ANA_AC_POL_POL_PORT_RATE_CFG_PORT_RATE] = 19,
	...
	[FW_ANA_CL_PORT_ID_CFG_LPORT_NUM] = 6,
	[FW_ANA_L2_AUTO_LRN_CFG_AUTO_LRN_ENA] = 30,
	[FW_ANA_L2_MISC_CFG_PIPELINE_PT] = 5,
	[FW_ANA_L2_MISC_CFG_BUM_SLB_IDX] = 7,
	[FW_ANA_L2_MISC_CFG_BDLB_IDX] = 7,
	...
	[FW_HSCH_HSCH_L0_CFG_NEXT_IDX] = 6,
	[FW_HSCH_HSCH_L0_CFG_NEXT_INP] = 4,
	...
	[FW_HSCH_HSCH_FORCE_CTRL_HFORCE_SE_IDX] = 11,
	...
	[FW_REW_CNT_CTRL_EVENT_CNT_PORT] = 6,
	[FW_REW_RLEG_CTRL_DECAP_IRLEG] = 7,
	[FW_VOP_VOE_MISC_CONFIG_VOE_ENA] = 3,
