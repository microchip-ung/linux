...
/* This file is autogenerated by cml-utils 2023-09-17 19:48:29 +0200.
 * Commit ID: 7e01ace63334c4a11f39259624b3fa60614ffc30
 */
...
#define ANA_AC_POL_POL_ACL_RATE_CFG_ACL_RATE     GENMASK(19, 0)
#define ANA_AC_POL_POL_ACL_RATE_CFG_ACL_RATE_SET(x)\
	FIELD_PREP(ANA_AC_POL_POL_ACL_RATE_CFG_ACL_RATE, x)
...
#define ANA_AC_POL_POL_ACL_CTRL_ACL_PIPELINE_PT  GENMASK(6, 3)
#define ANA_AC_POL_POL_ACL_CTRL_ACL_PIPELINE_PT_SET(x)\
	FIELD_PREP(ANA_AC_POL_POL_ACL_CTRL_ACL_PIPELINE_PT, x)
...
#define ANA_AC_POL_POL_PORT_RATE_CFG_PORT_RATE   GENMASK(19, 0)
#define ANA_AC_POL_POL_PORT_RATE_CFG_PORT_RATE_SET(x)\
	FIELD_PREP(ANA_AC_POL_POL_PORT_RATE_CFG_PORT_RATE, x)
...
#define PTP_PTP_PIN_CFG_PTP_PIN_ACTION\
	GENMASK((FPOS(FP_PTP_PTP_PIN_CFG_PTP_PIN_ACTION) + 2),\
		(FPOS(FP_PTP_PTP_PIN_CFG_PTP_PIN_ACTION)))
...
#define PTP_PTP_PIN_CFG_PTP_PIN_SYNC\
	GENMASK((FPOS(FP_PTP_PTP_PIN_CFG_PTP_PIN_SYNC) + 1),\
		(FPOS(FP_PTP_PTP_PIN_CFG_PTP_PIN_SYNC)))
...
#define REW_CNT_CTRL_EVENT_CNT_PORT              GENMASK(11, 5)
#define REW_CNT_CTRL_EVENT_CNT_PORT_SET(x)\
	FIELD_PREP(REW_CNT_CTRL_EVENT_CNT_PORT, x)
