...
#define AFI_MISC_CTRL                                                          \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_MISC], 0, 1, 32, 0, 0, 1, 4)
...
#define AFI_NEW_FRM_CTRL                                                       \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_MISC], 0, 1, 32, 4, 0, 1, 4)
...
#define AFI_NEW_FRM_INFO                                                       \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_MISC], 0, 1, 32, 8, 0, 1, 4)

#define AFI_NEW_FRM_INFO_FRM_INFO\
	GENMASK(regs->fsize[FW_AFI_NEW_FRM_INFO_FRM_INFO] + 0 - 1, 0)
...
#define AFI_FRM_NXT_AND_TYPE(g)                                                \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_FRM_TBL], g, regs->gcnt[GC_AFI_FRM_TBL],\
	      16, 0, 0, 1, 4)

#define AFI_FRM_NXT_AND_TYPE_NEXT_PTR\
	GENMASK(regs->fsize[FW_AFI_FRM_NXT_AND_TYPE_NEXT_PTR] + 0 - 1, 0)
...
#define AFI_TTI_PORT_QU(g)                                                     \
	__REG(TARGET_AFI, 0, 1, 0, g, regs->gcnt[GC_AFI_TTI_TBL], 32, 0, 0, 1, 4)

#define AFI_TTI_PORT_QU_PORT_NUM\
	GENMASK(regs->fsize[FW_AFI_TTI_PORT_QU_PORT_NUM] + 0 - 1, 0)
...
#define AFI_TTI_PORT_QU_QU_NUM\
	GENMASK(regs->fsize[FW_AFI_TTI_PORT_QU_QU_NUM] + 8 - 1, 8)
...
#define AFI_TTI_TIMER(g)                                                       \
	__REG(TARGET_AFI, 0, 1, 0, g, regs->gcnt[GC_AFI_TTI_TBL], 32, 4, 0, 1, 4)
...
#define AFI_TTI_FRM(g)                                                         \
	__REG(TARGET_AFI, 0, 1, 0, g, regs->gcnt[GC_AFI_TTI_TBL], 32, 8, 0, 1, 4)

#define AFI_TTI_FRM_FRM_PTR\
	GENMASK(regs->fsize[FW_AFI_TTI_FRM_FRM_PTR] + 0 - 1, 0)
...
#define AFI_TTI_TICKS(g)                                                       \
	__REG(TARGET_AFI, 0, 1, 0, g, regs->gcnt[GC_AFI_TTI_TBL], 32, 12, 0, 1, 4)
...
#define AFI_TTI_TICK_BASE                                                      \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_TTI_TICKS], 0, 1, 44, 0, 0, 1, 4)
...
#define AFI_TTI_TICK_LEN_0_3                                                   \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_TTI_TICKS], 0, 1, 44, 4, 0, 1, 4)
...
#define AFI_TTI_TICK_LEN_4_7                                                   \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_TTI_TICKS], 0, 1, 44, 8, 0, 1, 4)
...
#define AFI_TTI_CTRL                                                           \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_TTI_MISC], 0, 1, 68, 48, 0, 1, 4)
...
#define AFI_TTI_CTRL2                                                          \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_TTI_MISC], 0, 1, 68, 52, 0, 1, 4)
...
#define AFI_PORT_FRM_OUT(g)                                                    \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_PORT_TBL], g,                     \
	      regs->gcnt[GC_AFI_PORT_TBL], 8, 0, 0, 1, 4)
...
#define AFI_PORT_CFG(g)                                                        \
	__REG(TARGET_AFI, 0, 1, regs->gaddr[GA_AFI_PORT_TBL], g,                     \
	      regs->gcnt[GC_AFI_PORT_TBL], 8, 4, 0, 1, 4)
...
#define ANA_AC_AGGR_CFG(g)                                                     \
	__REG(TARGET_ANA_AC, 0, 1, regs->gaddr[GA_ANA_AC_AGGR], g, 16, 16, 0, 0, 1,  \
	      4)

/* SPARX5 ONLY */
/* ANA_AC:AGGR:AGGR_CFG1 */
#define ANA_AC_AGGR_CFG1(g)                                                    \
	__REG(TARGET_ANA_AC, 0, 1, regs->gaddr[GA_ANA_AC_AGGR], g, 16, 16, 4, 0, 1,  \
	      4)

/* SPARX5 ONLY */
/* ANA_AC:AGGR:AGGR_CFG2 */
#define ANA_AC_AGGR_CFG2(g)                                                    \
	__REG(TARGET_ANA_AC, 0, 1, regs->gaddr[GA_ANA_AC_AGGR], g, 16, 16, 8, 0, 1,  \
	      4)
...
#define ANA_AC_PORT_STAT_MSB_CNT(g, r)                                         \
	__REG(TARGET_ANA_AC, 0, 1, regs->gaddr[GA_ANA_AC_STAT_CNT_CFG_PORT], g,      \
	      regs->gcnt[GC_ANA_AC_STAT_CNT_CFG_PORT], 64, 36, r, 4, 4)
...
#define ANA_ACL_VCAP_S2_MISC_CTRL                                              \
	__REG(TARGET_ANA_ACL, 0, 1, regs->gaddr[GA_ANA_ACL_COMMON], 0, 1, 592, 416,  \
	      0, 1, 4)
...
#define ANA_ACL_VCAP_S2_MISC_CTRL2                                             \
	__REG(TARGET_ANA_ACL, 0, 1, regs->gaddr[GA_ANA_ACL_COMMON], 0, 1, 592, 420,  \
	      0, 1, 4)
...
#define ANA_CL_AGGR_CFG                                                        \
	__REG(TARGET_ANA_CL, 0, 1, regs->gaddr[GA_ANA_CL_COMMON], 0, 1, 756, 12, 0,  \
	      1, 4)
...
#define ANA_AC_POL_POL_ACL_RATE_CFG(r)                                         \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_ALL_CFG], 0, 1, \
	      1160, 96, r, regs->rcnt[RC_ANA_AC_POL_POL_ACL_RATE_CFG], 4)

#define ANA_AC_POL_POL_ACL_RATE_CFG_ACL_RATE\
	GENMASK(regs->fsize[FW_ANA_AC_POL_POL_ACL_RATE_CFG_ACL_RATE] + 0 - 1, 0)
...
#define ANA_AC_POL_POL_ACL_THRES_CFG(r)                                        \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_ALL_CFG], 0, 1, \
	      1160, 352, r, regs->rcnt[RC_ANA_AC_POL_POL_ACL_THRES_CFG], 4)
...
#define ANA_AC_POL_POL_ACL_CTRL(r)                                             \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_ALL_CFG], 0, 1, \
	      1160, 608, r, regs->rcnt[RC_ANA_AC_POL_POL_ACL_CTRL], 4)

#define ANA_AC_POL_POL_ACL_CTRL_ACL_PIPELINE_PT\
	GENMASK(regs->fsize[FW_ANA_AC_POL_POL_ACL_CTRL_ACL_PIPELINE_PT] + 3 - 1, 3)
...
#define ANA_AC_POL_POL_PORT_THRES_CFG_0(r)                                     \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_PORT_CFG], 0, 1,\
	      8192, 0, r, regs->rcnt[RC_ANA_AC_POL_POL_PORT_THRES_CFG_0], 4)
...
#define ANA_AC_POL_POL_PORT_THRES_CFG_1(r)                                     \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_PORT_CFG], 0, 1,\
	      8192, 2048, r, regs->rcnt[RC_ANA_AC_POL_POL_PORT_THRES_CFG_1], 4)
...
#define ANA_AC_POL_POL_PORT_RATE_CFG(r)                                        \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_PORT_CFG], 0, 1,\
	      8192, 4096, r, regs->rcnt[RC_ANA_AC_POL_POL_PORT_RATE_CFG], 4)

#define ANA_AC_POL_POL_PORT_RATE_CFG_PORT_RATE\
	GENMASK(regs->fsize[FW_ANA_AC_POL_POL_PORT_RATE_CFG_PORT_RATE] + 0 - 1, 0)
...
#define ANA_AC_POL_POL_PORT_GAP(g)                                             \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_PORT_CTRL], g,  \
	      regs->gcnt[GC_ANA_AC_POL_POL_PORT_CTRL], 32, 0, 0, 1, 4)
...
#define ANA_AC_POL_POL_PORT_CFG(g, r)                                          \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_POL_PORT_CTRL], g,  \
	      regs->gcnt[GC_ANA_AC_POL_POL_PORT_CTRL], 32, 4, r, 4, 4)
...
#define ANA_AC_POL_SLB_TRAFFIC_MASK_CFG(r)                                     \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_COMMON_BUM_SLB], 0, \
	      1, 20, 4, r, 3, 4)
...
#define ANA_AC_POL_SLB_MISC_CFG(g)                                             \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_BUM_SLB], g,        \
	      regs->gcnt[GC_ANA_AC_POL_BUM_SLB], 32, 0, 0, 1, 4)
...
#define ANA_AC_POL_SLB_SLB_CFG(g)                                              \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_BUM_SLB], g,        \
	      regs->gcnt[GC_ANA_AC_POL_BUM_SLB], 32, 4, 0, 1, 4)
...
#define ANA_AC_POL_SLB_LB_CFG(g, r)                                            \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_BUM_SLB], g,        \
	      regs->gcnt[GC_ANA_AC_POL_BUM_SLB], 32, 8, r, 3, 4)
...
#define ANA_AC_POL_SLB_LB_BUCKET_VAL(g, r)                                     \
	__REG(TARGET_ANA_AC_POL, 0, 1, regs->gaddr[GA_ANA_AC_POL_BUM_SLB], g,        \
	      regs->gcnt[GC_ANA_AC_POL_BUM_SLB], 32, 20, r, 3, 4)

#define ANA_AC_POL_SLB_LB_BUCKET_VAL_BUCKET_VAL\
	GENMASK(regs->fsize[FW_ANA_AC_POL_SLB_LB_BUCKET_VAL_BUCKET_VAL] + 9 - 1, 9)
...
#define ANA_CL_PORT_ID_CFG(g)                                                  \
	__REG(TARGET_ANA_CL, 0, 1, regs->gaddr[GA_ANA_CL_PORT], g,                   \
	      regs->gcnt[GC_ANA_CL_PORT], 512, 104, 0, 1, 4)
...
#define ANA_CL_PORT_ID_CFG_LPORT_NUM\
	GENMASK(regs->fsize[FW_ANA_CL_PORT_ID_CFG_LPORT_NUM] + 0 - 1, 0)
...
#define ANA_CL_CAPTURE_CFG(g)                                                  \
	__REG(TARGET_ANA_CL, 0, 1, regs->gaddr[GA_ANA_CL_PORT], g,                   \
	      regs->gcnt[GC_ANA_CL_PORT], 512, 184, 0, 1, 4)
...
#define ANA_L2_MISC_CFG(g)                                                     \
	__REG(TARGET_ANA_L2, 0, 1, 0, g, regs->gcnt[GC_ANA_L2_ISDX], 128, 20, 0, 1,  \
	      4)

#define ANA_L2_MISC_CFG_CT_DIS\
	BIT(regs->fpos[FP_ANA_L2_MISC_CFG_CT_DIS])
...
#define ANA_L2_MISC_CFG_RSDX_DIS\
	BIT(regs->fpos[FP_ANA_L2_MISC_CFG_RSDX_DIS])
...
#define ANA_L2_MISC_CFG_PIPELINE_PT\
	GENMASK(regs->fsize[FW_ANA_L2_MISC_CFG_PIPELINE_PT] + 21 - 1, 21)
...
#define ANA_L2_MISC_CFG_BUM_SLB_IDX\
	GENMASK(regs->fsize[FW_ANA_L2_MISC_CFG_BUM_SLB_IDX] + 10 - 1, 10)
...
#define ANA_L2_MISC_CFG_BDLB_IDX\
	GENMASK(regs->fsize[FW_ANA_L2_MISC_CFG_BDLB_IDX] + 0 - 1, 0)
...
#define ANA_L3_L3_UC_ENA                                                       \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 8, 0, 1,\
	      4)

/* SPARX5 ONLY */
/* ANA_L3:COMMON:L3_UC_ENA1 */
#define ANA_L3_L3_UC_ENA1                                                      \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 12, 0,  \
	      1, 4)

/* SPARX5 ONLY */
/* ANA_L3:COMMON:L3_UC_ENA2 */
#define ANA_L3_L3_UC_ENA2                                                      \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 16, 0,  \
	      1, 4)
...
#define ANA_L3_ROUTING_CFG                                                     \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 104, 0, \
	      1, 4)
...
#define ANA_L3_ROUTING_CFG2                                                    \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 108, 0, \
	      1, 4)
...
#define ANA_L3_RLEG_CFG_0                                                      \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 112, 0, \
	      1, 4)
...
#define ANA_L3_RLEG_CFG_1                                                      \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 116, 0, \
	      1, 4)
...
#define ANA_L3_CPU_QU_CFG                                                      \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 120, 0, \
	      1, 4)
...
#define ANA_L3_CPU_QU_CFG2                                                     \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 124, 0, \
	      1, 4)
...
#define ANA_L3_SIP_SECURE_ENA                                                  \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 144, 0, \
	      1, 4)

/* ANA_L3:COMMON:SIP_SECURE_ENA1 */
#define ANA_L3_SIP_SECURE_ENA1                                                 \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 148, 0, \
	      1, 4)

/* SPARX5 ONLY */
/* ANA_L3:COMMON:SIP_SECURE_ENA2 */
#define ANA_L3_SIP_SECURE_ENA2                                                 \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 152, 0, \
	      1, 4)
...
#define ANA_L3_DIP_SECURE_ENA                                                  \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 156, 0, \
	      1, 4)

/* SPARX5 ONLY */
/* ANA_L3:COMMON:DIP_SECURE_ENA1 */
#define ANA_L3_DIP_SECURE_ENA1                                                 \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 160, 0, \
	      1, 4)

/* SPARX5 ONLY */
/* ANA_L3:COMMON:DIP_SECURE_ENA2 */
#define ANA_L3_DIP_SECURE_ENA2                                                 \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_COMMON], 0, 1, 184, 164, 0, \
	      1, 4)
...
#define ANA_L3_VMID_CFG(g)                                                     \
	__REG(TARGET_ANA_L3, 0, 1, 0, g, regs->gcnt[GC_ANA_L3_VLAN], 64, 0, 0, 1, 4)
...
#define ANA_L3_BUM_CFG(g)                                                      \
	__REG(TARGET_ANA_L3, 0, 1, 0, g, regs->gcnt[GC_ANA_L3_VLAN], 64, 4, 0, 1, 4)

#define ANA_L3_BUM_CFG_BUM_SLB_IDX\
	GENMASK(regs->fsize[FW_ANA_L3_BUM_CFG_BUM_SLB_IDX] + 0 - 1, 0)
...
#define ANA_L3_L3MC_CTRL(g)                                                    \
	__REG(TARGET_ANA_L3, 0, 1, regs->gaddr[GA_ANA_L3_L3MC], g,                   \
	      regs->gcnt[GC_ANA_L3_L3MC], 32, 16, 0, 1, 4)
...
#define ANA_L3_L3MC_CTRL_RPF_VMID\
	GENMASK(regs->fsize[FW_ANA_L3_L3MC_CTRL_RPF_VMID] + 8 - 1, 8)
...
#define DEV2G5_ENABLE_CONFIG(t)                                                \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], regs->gaddr[GA_DEV2G5_MM_CONFIG],  \
	      0, 1, 8, 0, 0, 1, 4)
...
#define DEV2G5_MM_STATUS(t)                                                    \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5],                              \
	      regs->gaddr[GA_DEV2G5_MM_STATISTICS], 0, 1, 4, 0, 0, 1, 4)
...
#define DEV10G_ENABLE_CONFIG(t)                                                \
	__REG(TARGET_DEV10G, t, regs->tsize[TC_DEV10G], 520, 0, 1, 8, 0, 0, 1, 4)
...
#define DEV10G_VERIF_CONFIG(t)                                                 \
	__REG(TARGET_DEV10G, t, regs->tsize[TC_DEV10G], 520, 0, 1, 8, 4, 0, 1, 4)
...
#define DEV10G_MM_STATUS(t)                                                    \
	__REG(TARGET_DEV10G, t, regs->tsize[TC_DEV10G], 528, 0, 1, 4, 0, 0, 1, 4)
...
#define DEV10G_USXGMII_ANEG_CFG(t)                                             \
	__REG(TARGET_DEV10G, t, regs->tsize[TC_DEV10G], 532, 0, 1, 16, 0, 0, 1, 4)
...
#define DEV10G_USXGMII_ANEG_STATUS(t)                                          \
	__REG(TARGET_DEV10G, t, regs->tsize[TC_DEV10G], 532, 0, 1, 16, 4, 0, 1, 4)
...
#define DEV10G_DEV_PFRAME_CFG(t)                                               \
	__REG(TARGET_DEV10G, t, regs->tsize[TC_DEV10G], 548, 0, 1, 28, 24, 0, 1, 4)
...
#define DEV2G5_USXGMII_TX_RADAPT_CFG(t)                                        \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], 0, 0, 1, 36, 20, 0, 1, 4)
...
#define DEV2G5_USXGMII_GMII_XGMII_MAP_CFG(t)                                   \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], 0, 0, 1, 36, 24, 0, 1, 4)
...
#define DEV2G5_USXGMII_RX_RADAPT_CFG(t)                                        \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], 0, 0, 1, 36, 28, 0, 1, 4)
...
#define DEV2G5_USXGMII_ANEG_CFG(t)                                             \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], 36, 0, 1, 16, 0, 0, 1, 4)
...
#define DEV2G5_USXGMII_ANEG_STATUS(t)                                          \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], 36, 0, 1, 16, 4, 0, 1, 4)
...
#define DEV2G5_DEV_PFRAME_CFG(t)                                               \
	__REG(TARGET_DEV2G5, t, regs->tsize[TC_DEV2G5], 172, 0, 1, 28, 24, 0, 1, 4)
...
#define DSM_IPG_SHRINK_CFG(r)                                                  \
	__REG(TARGET_DSM, 0, 1, 20, 0, 1, 3528, 536, r,                        \
	      regs->rcnt[RC_DSM_IPG_SHRINK_CFG], 4)
...
#define DSM_PREEMPT_CFG(r)                                                     \
	__REG(TARGET_DSM, 0, 1, 20, 0, 1, 3528, 3260, r,                       \
	      regs->rcnt[RC_DSM_PREEMPT_CFG], 4)
...
#define EACL_RLEG_CFG_0                                                        \
	__REG(TARGET_EACL, 0, 1, regs->gaddr[GA_EACL_COMMON], 0, 1, 216, 64, 0, 1,   \
	      4)
...
#define EACL_RLEG_CFG_1                                                        \
	__REG(TARGET_EACL, 0, 1, regs->gaddr[GA_EACL_COMMON], 0, 1, 216, 68, 0, 1,   \
	      4)
...
#define HSCH_HSCH_L0_CFG(g)                                                    \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_HSCH_L0_CFG], g,                \
	      regs->gcnt[GC_HSCH_HSCH_L0_CFG], 4, 0, 0, 1, 4)
...
#define HSCH_HSCH_L0_CFG_NEXT_IDX\
	GENMASK(regs->fsize[FW_HSCH_HSCH_L0_CFG_NEXT_IDX] + 14 - 1, 14)
...
#define HSCH_HSCH_L0_CFG_NEXT_INP\
	GENMASK(regs->fsize[FW_HSCH_HSCH_L0_CFG_NEXT_INP] + 8 - 1, 8)
...
#define HSCH_HSCH_FORCE_CTRL                                                   \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_HSCH_MISC], 0, 1, 648, 644, 0,  \
	      1, 4)
...
#define HSCH_HSCH_FORCE_CTRL_HFORCE_SE_IDX\
	GENMASK(regs->fsize[FW_HSCH_HSCH_FORCE_CTRL_HFORCE_SE_IDX] + 1 - 1, 1)
...
#define HSCH_TAS_CFG_CTRL2                                                     \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_CONFIG], 0, 1,              \
	      regs->gsize[GW_HSCH_TAS_CONFIG], 12, 0, 1, 4)
...
#define HSCH_TAS_PROFILE_CONFIG(g)                                             \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_PROFILE_CFG], g,            \
	      regs->gcnt[GC_HSCH_TAS_PROFILE_CFG], regs->gsize[GW_HSCH_TAS_PROFILE_CFG],   \
	      32, 0, 1, 4)
...
#define HSCH_TAS_BASE_TIME_NSEC                                                \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 0, 0,  \
	      1, 4)
...
#define HSCH_TAS_BASE_TIME_SEC_LSB                                             \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 4, 0,  \
	      1, 4)

/* HSCH:TAS_LIST_CFG:TAS_BASE_TIME_SEC_MSB */
#define HSCH_TAS_BASE_TIME_SEC_MSB                                             \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 8, 0,  \
	      1, 4)
...
#define HSCH_TAS_NEXT_OPER_TIME_NSEC                                           \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 12, 0, \
	      1, 4)
...
#define HSCH_TAS_NEXT_OPER_TIME_SEC_LSB                                        \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 16, 0, \
	      1, 4)

/* HSCH:TAS_LIST_CFG:TAS_NEXT_OPER_TIME_SEC_MSB */
#define HSCH_TAS_NEXT_OPER_TIME_SEC_MSB                                        \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 20, 0, \
	      1, 4)
...
#define HSCH_TAS_CYCLE_TIME_CFG                                                \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 24, 0, \
	      1, 4)

/* HSCH:TAS_LIST_CFG:TAS_STARTUP_CFG */
#define HSCH_TAS_STARTUP_CFG                                                   \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 28, 0, \
	      1, 4)
...
#define HSCH_TAS_LIST_CFG                                                      \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 32, 0, \
	      1, 4)
...
#define HSCH_TAS_LIST_STATE                                                    \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 36, 0, \
	      1, 4)
...
#define HSCH_TAS_LIST_STATE_INT                                                \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 40, 0, \
	      1, 4)

/* LAN969X ONLY */
/* HSCH:TAS_LIST_CFG:TAS_LIST_PTR_STATE */
#define HSCH_TAS_LIST_PTR_STATE                                                \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_TAS_LIST_CFG], 0, 1, 64, 44, 0, \
	      1, 4)
...
#define HSCH_TAS_GATE_STATE                                                    \
	__REG(TARGET_HSCH, 0, 1, regs->gaddr[GA_HSCH_HSCH_TAS_STATE], 0, 1, 4, 0, 0, \
	      1, 4)
...
#define PORT_CONF_USXGMII_CFG(g)                                               \
       __REG(TARGET_PORT_CONF, 0, 1, regs->gaddr[GA_PORT_CONF_USXGMII_CFG], g,      \
             regs->gcnt[GC_PORT_CONF_USXGMII_CFG], 12, 0, 0, 1, 4)
...
#define PORT_CONF_USXGMII_AM_CFG(g)                                            \
       __REG(TARGET_PORT_CONF, 0, 1, regs->gaddr[GA_PORT_CONF_USXGMII_CFG], g,      \
             regs->gcnt[GC_PORT_CONF_USXGMII_CFG], 12, 4, 0, 1, 4)
...
#define PORT_CONF_USXGMII_LFRF_SEQ(g)                                          \
       __REG(TARGET_PORT_CONF, 0, 1, regs->gaddr[GA_PORT_CONF_USXGMII_CFG], g,      \
             regs->gcnt[GC_PORT_CONF_USXGMII_CFG], 12, 8, 0, 1, 4)
...
#define PORT_CONF_USXGMII_RX_STATUS(g)                                         \
       __REG(TARGET_PORT_CONF, 0, 1, regs->gaddr[GA_PORT_CONF_USXGMII_STAT], g,     \
             regs->gcnt[GC_PORT_CONF_USXGMII_STAT], 8, 0, 0, 1, 4)
...
#define PORT_CONF_USXGMII_RX_ERR_STATUS(g)                                     \
       __REG(TARGET_PORT_CONF, 0, 1, regs->gaddr[GA_PORT_CONF_USXGMII_STAT], g,     \
             regs->gcnt[GC_PORT_CONF_USXGMII_STAT], 8, 4, 0, 1, 4)
...
#define REW_RLEG_CFG_0                                                         \
	__REG(TARGET_REW, 0, 1, regs->gaddr[GA_REW_COMMON], 0, 1, 1232, 1156, 0, 1,  \
	      4)
...
#define REW_RLEG_CFG_1                                                         \
	__REG(TARGET_REW, 0, 1, regs->gaddr[GA_REW_COMMON], 0, 1, 1232, 1160, 0, 1,  \
	      4)
...
/* REW:COMMON:CNT_CTRL */
#define REW_CNT_CTRL                                                           \
	__REG(TARGET_REW, 0, 1, regs->gaddr[GA_REW_COMMON], 0, 1, 1232, 1164, 0, 1,  \
	      4)

#define REW_CNT_CTRL_EVENT_CNT_PORT\
	GENMASK(regs->fsize[FW_REW_CNT_CTRL_EVENT_CNT_PORT] + 5 - 1, 5)
...
#define REW_RLEG_CTRL(g)                                                       \
	__REG(TARGET_REW, 0, 1, regs->gaddr[GA_REW_VMID], g, regs->gcnt[GC_REW_VMID], 4, 0,\
	      0, 1, 4)
...
/* VOP:COMMON:VOP_CTRL */
#define VOP_VOP_CTRL                                                           \
	__REG(TARGET_VOP, 0, 1, regs->gaddr[GA_VOP_COMMON], 0, 1,                    \
	      regs->gsize[GW_VOP_COMMON], 0, 0, 1, 4)
...
#define VOP_LOC_PERIOD_CFG(r)                                                  \
	__REG(TARGET_VOP, 0, 1, regs->gaddr[GA_VOP_COMMON], 0, 1,                    \
	      regs->gsize[GW_VOP_COMMON], 180, r, regs->rcnt[RC_VOP_LOC_PERIOD_CFG], 4)
...
#define VOP_MASTER_INTR_CTRL                                                   \
	__REG(TARGET_VOP, 0, 1, regs->gaddr[GA_VOP_COMMON], 0, 1,                    \
	      regs->gsize[GW_VOP_COMMON], regs->raddr[RA_VOP_MASTER_INTR_CTRL], 0, 1, 4)
...
#define VOP_VOE_MISC_CONFIG(g)                                                 \
	__REG(TARGET_VOP, 0, 1, regs->gaddr[GA_VOP_VOE_CONF_REG], g,                 \
	      regs->gcnt[GC_VOP_VOE_CONF_REG], 4, 0, 0, 1, 4)

#define VOP_VOE_MISC_CONFIG_VOE_ENA\
	GENMASK(regs->fsize[FW_VOP_VOE_MISC_CONFIG_VOE_ENA] + 4 - 1, 4)
