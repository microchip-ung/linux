...
/* This file is autogenerated by cml-utils 2022-11-17 13:43:27 +0100.
 * Commit ID: a73fce95034a2578793fce6b29225b958beb8b6e
 */
...
#define ANA_AC_PROBE_CFG(g)       __REG(TARGET_ANA_AC, 0, 1, 893696, g, 3, 32, 0, 0, 1, 4)
...
#define ANA_AC_PROBE_CFG2(g)      __REG(TARGET_ANA_AC, 0, 1, 893696, g, 3, 32, 4, 0, 1, 4)
...
#define ANA_AC_PROBE_PORT_CFG(g)  __REG(TARGET_ANA_AC, 0, 1, 893696, g, 3, 32, 8, 0, 1, 4)

/*      ANA_AC:MIRROR_PROBE:PROBE_PORT_CFG1 */
#define ANA_AC_PROBE_PORT_CFG1(g) __REG(TARGET_ANA_AC, 0, 1, 893696, g, 3, 32, 12, 0, 1, 4)

/*      ANA_AC:MIRROR_PROBE:PROBE_PORT_CFG2 */
#define ANA_AC_PROBE_PORT_CFG2(g) __REG(TARGET_ANA_AC, 0, 1, 893696, g, 3, 32, 16, 0, 1, 4)
...
#define ANA_AC_STICKY             __REG(TARGET_ANA_AC, 0, 1, 839128, 0, 1, 4, 0, 0, 1, 4)
...
#define ANA_AC_STICKY_MASK(g)     __REG(TARGET_ANA_AC, 0, 1, 894824, g, 4, 64, 0, 0, 1, 4)
...
#define ANA_AC_TSN_SF             __REG(TARGET_ANA_AC, 0, 1, 839136, 0, 1, 4, 0, 0, 1, 4)
...
#define ANA_AC_TSN_SF_CFG(g)      __REG(TARGET_ANA_AC, 0, 1, 839680, g, 1024, 4, 0, 0, 1, 4)
...
#define ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_ENA BIT(1)
#define ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_ENA_SET(x)\
	FIELD_PREP(ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_ENA, x)
#define ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_ENA_GET(x)\
	FIELD_GET(ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_ENA, x)

#define ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_STATE BIT(0)
#define ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_STATE_SET(x)\
	FIELD_PREP(ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_STATE, x)
#define ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_STATE_GET(x)\
	FIELD_GET(ANA_AC_TSN_SF_CFG_TSN_STREAM_BLOCK_OVERSIZE_STATE, x)

/*      ANA_AC:TSN_SF_STATUS:TSN_SF_STATUS */
#define ANA_AC_TSN_SF_STATUS      __REG(TARGET_ANA_AC, 0, 1, 839072, 0, 1, 16, 0, 0, 1, 4)
...
#define ANA_AC_SG_ACCESS_CTRL     __REG(TARGET_ANA_AC, 0, 1, 839140, 0, 1, 12, 0, 0, 1, 4)
...
#define ANA_AC_SG_CYCLETIME_UPDATE_PERIOD __REG(TARGET_ANA_AC, 0, 1, 839140, 0, 1, 12, 8, 0, 1, 4)
...
#define ANA_AC_SG_CONFIG_REG_1    __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 48, 0, 1, 4)

/*      ANA_AC:SG_CONFIG:SG_CONFIG_REG_2 */
#define ANA_AC_SG_CONFIG_REG_2    __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 52, 0, 1, 4)

/*      ANA_AC:SG_CONFIG:SG_CONFIG_REG_3 */
#define ANA_AC_SG_CONFIG_REG_3    __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 56, 0, 1, 4)
...
#define ANA_AC_SG_CONFIG_REG_4    __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 60, 0, 1, 4)

/*      ANA_AC:SG_CONFIG:SG_CONFIG_REG_5 */
#define ANA_AC_SG_CONFIG_REG_5    __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 64, 0, 1, 4)

/*      ANA_AC:SG_CONFIG:SG_GCL_GS_CONFIG */
#define ANA_AC_SG_GCL_GS_CONFIG(r) __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 0, r, 4, 4)
...
#define ANA_AC_SG_GCL_TI_CONFIG(r) __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 16, r, 4, 4)

/*      ANA_AC:SG_CONFIG:SG_GCL_OCT_CONFIG */
#define ANA_AC_SG_GCL_OCT_CONFIG(r) __REG(TARGET_ANA_AC, 0, 1, 851584, 0, 1, 128, 32, r, 4, 4)

/*      ANA_AC:SG_STATUS:SG_STATUS_REG_1 */
#define ANA_AC_SG_STATUS_REG_1    __REG(TARGET_ANA_AC, 0, 1, 839088, 0, 1, 16, 0, 0, 1, 4)

/*      ANA_AC:SG_STATUS:SG_STATUS_REG_2 */
#define ANA_AC_SG_STATUS_REG_2    __REG(TARGET_ANA_AC, 0, 1, 839088, 0, 1, 16, 4, 0, 1, 4)

/*      ANA_AC:SG_STATUS:SG_STATUS_REG_3 */
#define ANA_AC_SG_STATUS_REG_3    __REG(TARGET_ANA_AC, 0, 1, 839088, 0, 1, 16, 8, 0, 1, 4)
...
#define ANA_AC_SG_STATUS_REG_4    __REG(TARGET_ANA_AC, 0, 1, 839088, 0, 1, 16, 12, 0, 1, 4)
...
#define ANA_AC_PORT_STAT_MSB_CNT(g, r) __REG(TARGET_ANA_AC, 0, 1, 843776, g, 70, 64, 36, r, 4, 4)
...
#define ANA_AC_ACL_STAT_GLOBAL_CFG(r) __REG(TARGET_ANA_AC, 0, 1, 893792, 0, 1, 24, 8, r, 2, 4)
...
#define ANA_AC_ACL_STAT_LSB_CNT(g, r) __REG(TARGET_ANA_AC, 0, 1, 848896, g, 64, 16, 0, r, 2, 4)
...
#define ANA_AC_POL_POL_ACL_RATE_CFG(r) __REG(TARGET_ANA_AC_POL,\
					0, 1, 75968, 0, 1, 1160, 96, r, 64, 4)
...
#define ANA_AC_POL_POL_ACL_THRES_CFG(r) __REG(TARGET_ANA_AC_POL,\
					0, 1, 75968, 0, 1, 1160, 352, r, 64, 4)
...
#define ANA_AC_POL_POL_ACL_CTRL(r) __REG(TARGET_ANA_AC_POL, 0, 1, 75968, 0, 1, 1160, 608, r, 64, 4)
...
#define ANA_AC_POL_POL_ALL_CFG    __REG(TARGET_ANA_AC_POL, 0, 1, 75968, 0, 1, 1160, 1144, 0, 1, 4)
...
#define ANA_AC_POL_POL_PORT_THRES_CFG_0(r) __REG(TARGET_ANA_AC_POL,\
					0, 1, 65536, 0, 1, 8192, 0, r, 280, 4)
...
#define ANA_AC_POL_POL_PORT_THRES_CFG_1(r) __REG(TARGET_ANA_AC_POL,\
					0, 1, 65536, 0, 1, 8192, 2048, r, 280, 4)
...
#define ANA_AC_POL_POL_PORT_RATE_CFG(r) __REG(TARGET_ANA_AC_POL,\
					0, 1, 65536, 0, 1, 8192, 4096, r, 280, 4)
...
#define ANA_AC_POL_POL_PORT_GAP(g) __REG(TARGET_ANA_AC_POL, 0, 1, 73728, g, 70, 32, 0, 0, 1, 4)
...
#define ANA_AC_POL_POL_PORT_CFG(g, r) __REG(TARGET_ANA_AC_POL, 0, 1, 73728, g, 70, 32, 4, r, 4, 4)
...
#define ANA_AC_SDLB_XLB_START(g)  __REG(TARGET_ANA_AC_SDLB, 0, 1, 295468, g, 10, 24, 0, 0, 1, 4)
...
#define ANA_AC_SDLB_PUP_INTERVAL(g) __REG(TARGET_ANA_AC_SDLB, 0, 1, 295468, g, 10, 24, 4, 0, 1, 4)
...
#define ANA_AC_SDLB_PUP_CTRL(g)   __REG(TARGET_ANA_AC_SDLB, 0, 1, 295468, g, 10, 24, 8, 0, 1, 4)
...
#define ANA_AC_SDLB_LBGRP_MISC(g) __REG(TARGET_ANA_AC_SDLB, 0, 1, 295468, g, 10, 24, 12, 0, 1, 4)
...
#define ANA_AC_SDLB_PUP_TOKENS(g, r) __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 0, r, 2, 4)
...
#define ANA_AC_SDLB_THRES(g, r)   __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 8, r, 2, 4)
...
#define ANA_AC_SDLB_XLB_NEXT(g)   __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 16, 0, 1, 4)
...
#define ANA_AC_SDLB_INH_CTRL(g, r) __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 20, r, 2, 4)
...
#define ANA_AC_SDLB_INH_LBSET_ADDR(g) __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 28, 0, 1, 4)
...
#define ANA_AC_SDLB_DLB_MISC(g)   __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 32, 0, 1, 4)
...
#define ANA_AC_SDLB_DLB_CFG(g)    __REG(TARGET_ANA_AC_SDLB, 0, 1, 0, g, 4616, 64, 36, 0, 1, 4)
...
#define ANA_CL_CLM_FRAGMENT_CFG   __REG(TARGET_ANA_CL, 0, 1, 166912, 0, 1, 756, 252, 0, 1, 4)
...
#define ANA_L2_FWD_CFG            __REG(TARGET_ANA_L2, 0, 1, 566024, 0, 1, 700, 0, 0, 1, 4)
...
/*      ANA_L2:ISDX:DLB_CFG */
#define ANA_L2_DLB_CFG(g)         __REG(TARGET_ANA_L2, 0, 1, 0, g, 4096, 128, 56, 0, 1, 4)
...
/*      ANA_L2:ISDX:TSN_CFG */
#define ANA_L2_TSN_CFG(g)         __REG(TARGET_ANA_L2, 0, 1, 0, g, 4096, 128, 100, 0, 1, 4)
...
#define ANA_L3_SIP_SECURE_ENA     __REG(TARGET_ANA_L3, 0, 1, 493632, 0, 1, 184, 144, 0, 1, 4)

/*      ANA_L3:COMMON:SIP_SECURE_ENA1 */
#define ANA_L3_SIP_SECURE_ENA1    __REG(TARGET_ANA_L3, 0, 1, 493632, 0, 1, 184, 148, 0, 1, 4)

/*      ANA_L3:COMMON:SIP_SECURE_ENA2 */
#define ANA_L3_SIP_SECURE_ENA2    __REG(TARGET_ANA_L3, 0, 1, 493632, 0, 1, 184, 152, 0, 1, 4)
...
#define QFWD_FRAME_COPY_CFG(r)    __REG(TARGET_QFWD, 0, 1, 0, 0, 1, 340, 284, r, 12, 4)
...
#define REW_RTAG_ETAG_CTRL(r)     __REG(TARGET_REW, 0, 1, 387264, 0, 1, 1232, 560, r, 70, 4)
...
/*      REW:COMMON:ES0_CTRL */
#define REW_ES0_CTRL              __REG(TARGET_REW, 0, 1, 387264, 0, 1, 1232, 852, 0, 1, 4)
...
/*      REW:COMMON:CNT_CTRL */
#define REW_CNT_CTRL              __REG(TARGET_REW, 0, 1, 387264, 0, 1, 1232, 1164, 0, 1, 4)
...
#define VCAP_ES0_CTRL             __REG(TARGET_VCAP_ES0, 0, 1, 0, 0, 1, 8, 0, 0, 1, 4)
...
#define VCAP_ES0_CFG              __REG(TARGET_VCAP_ES0, 0, 1, 0, 0, 1, 8, 4, 0, 1, 4)
...
#define VCAP_ES0_VCAP_ENTRY_DAT(r) __REG(TARGET_VCAP_ES0, 0, 1, 8, 0, 1, 904, 0, r, 64, 4)

/*      VCAP_ES0:VCAP_CORE_CACHE:VCAP_MASK_DAT */
#define VCAP_ES0_VCAP_MASK_DAT(r) __REG(TARGET_VCAP_ES0, 0, 1, 8, 0, 1, 904, 256, r, 64, 4)

/*      VCAP_ES0:VCAP_CORE_CACHE:VCAP_ACTION_DAT */
#define VCAP_ES0_VCAP_ACTION_DAT(r) __REG(TARGET_VCAP_ES0, 0, 1, 8, 0, 1, 904, 512, r, 64, 4)

/*      VCAP_ES0:VCAP_CORE_CACHE:VCAP_CNT_DAT */
#define VCAP_ES0_VCAP_CNT_DAT(r)  __REG(TARGET_VCAP_ES0, 0, 1, 8, 0, 1, 904, 768, r, 32, 4)

/*      VCAP_ES0:VCAP_CORE_CACHE:VCAP_CNT_FW_DAT */
#define VCAP_ES0_VCAP_CNT_FW_DAT  __REG(TARGET_VCAP_ES0, 0, 1, 8, 0, 1, 904, 896, 0, 1, 4)

/*      VCAP_ES0:VCAP_CORE_CACHE:VCAP_TG_DAT */
#define VCAP_ES0_VCAP_TG_DAT      __REG(TARGET_VCAP_ES0, 0, 1, 8, 0, 1, 904, 900, 0, 1, 4)

/*      VCAP_ES0:VCAP_CORE_MAP:VCAP_CORE_IDX */
#define VCAP_ES0_IDX              __REG(TARGET_VCAP_ES0, 0, 1, 912, 0, 1, 8, 0, 0, 1, 4)
...
#define VCAP_ES0_MAP              __REG(TARGET_VCAP_ES0, 0, 1, 912, 0, 1, 8, 4, 0, 1, 4)
...
#define VCAP_ES0_VCAP_STICKY      __REG(TARGET_VCAP_ES0, 0, 1, 920, 0, 1, 4, 0, 0, 1, 4)
...
#define VCAP_ES0_VCAP_VER         __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 0, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:ENTRY_WIDTH */
#define VCAP_ES0_ENTRY_WIDTH      __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 4, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:ENTRY_CNT */
#define VCAP_ES0_ENTRY_CNT        __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 8, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:ENTRY_SWCNT */
#define VCAP_ES0_ENTRY_SWCNT      __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 12, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:ENTRY_TG_WIDTH */
#define VCAP_ES0_ENTRY_TG_WIDTH   __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 16, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:ACTION_DEF_CNT */
#define VCAP_ES0_ACTION_DEF_CNT   __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 20, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:ACTION_WIDTH */
#define VCAP_ES0_ACTION_WIDTH     __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 24, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:CNT_WIDTH */
#define VCAP_ES0_CNT_WIDTH        __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 28, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:CORE_CNT */
#define VCAP_ES0_CORE_CNT         __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 32, 0, 1, 4)

/*      VCAP_ES0:VCAP_CONST:IF_CNT */
#define VCAP_ES0_IF_CNT           __REG(TARGET_VCAP_ES0, 0, 1, 924, 0, 1, 40, 36, 0, 1, 4)
