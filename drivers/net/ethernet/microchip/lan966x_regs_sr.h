...
/* This file is autogenerated by cml-utils 2022-09-04 20:57:51 +0200.
 * Commit ID: 735fe7798db070f1f48bc03571982ff954299810 (dirty)
 */
...
/*      AFI:MISC:MISC_CTRL */
#define AFI_MISC_CTRL             __REG(TARGET_AFI, 0, 1, 3664, 0, 1, 32, 0, 0, 1, 4)
...
#define AFI_NEW_FRM_CTRL          __REG(TARGET_AFI, 0, 1, 3664, 0, 1, 32, 4, 0, 1, 4)
...
#define AFI_NEW_FRM_INFO          __REG(TARGET_AFI, 0, 1, 3664, 0, 1, 32, 8, 0, 1, 4)

#define AFI_NEW_FRM_INFO_FRM_INFO                GENMASK(16, 0)
...
#define AFI_FRM_NXT_AND_TYPE(g)   __REG(TARGET_AFI, 0, 1, 2048, g, 64, 16, 0, 0, 1, 4)

#define AFI_FRM_NXT_AND_TYPE_NEXT_PTR            GENMASK(5, 0)
...
#define AFI_FRM_ENTRY_PART0(g)    __REG(TARGET_AFI, 0, 1, 2048, g, 64, 16, 4, 0, 1, 4)
...
#define AFI_FRM_ENTRY_PART1(g)    __REG(TARGET_AFI, 0, 1, 2048, g, 64, 16, 8, 0, 1, 4)
...
#define AFI_TTI_PORT_QU(g)        __REG(TARGET_AFI, 0, 1, 0, g, 64, 32, 0, 0, 1, 4)
...
#define AFI_TTI_TIMER(g)          __REG(TARGET_AFI, 0, 1, 0, g, 64, 32, 4, 0, 1, 4)
...
/*      AFI:TTI_TBL:TTI_FRM */
#define AFI_TTI_FRM(g)            __REG(TARGET_AFI, 0, 1, 0, g, 64, 32, 8, 0, 1, 4)

#define AFI_TTI_FRM_FRM_PTR                      GENMASK(5, 0)
...
#define AFI_TTI_TICKS(g)          __REG(TARGET_AFI, 0, 1, 0, g, 64, 32, 12, 0, 1, 4)
...
#define AFI_TTI_TICK_BASE         __REG(TARGET_AFI, 0, 1, 3888, 0, 1, 44, 0, 0, 1, 4)

#define AFI_TTI_TICK_BASE_BASE_LEN               GENMASK(11, 0)
...
#define AFI_TTI_TICK_BASE_BASE_CNT               GENMASK(27, 16)
...
#define AFI_TTI_TICK_LEN_0_3      __REG(TARGET_AFI, 0, 1, 3888, 0, 1, 44, 4, 0, 1, 4)
...
#define AFI_TTI_TICK_LEN_4_7      __REG(TARGET_AFI, 0, 1, 3888, 0, 1, 44, 8, 0, 1, 4)
...
#define AFI_TTI_CTRL              __REG(TARGET_AFI, 0, 1, 3932, 0, 1, 64, 48, 0, 1, 4)
...
#define AFI_PORT_FRM_OUT(g)       __REG(TARGET_AFI, 0, 1, 3584, g, 10, 8, 0, 0, 1, 4)
...
#define AFI_PORT_CFG(g)           __REG(TARGET_AFI, 0, 1, 3584, g, 10, 8, 4, 0, 1, 4)
...
#define ANA_MACTINDX_BUCKET                      GENMASK(10, 9)
...
#define ANA_MACTINDX_M_INDEX                     GENMASK(8, 0)
...
#define ANA_POL_FLOWC(r)          __REG(TARGET_ANA, 0, 1, 28544, 0, 1, 116, 0, r, 27, 4)
...
#define CPU_ULPI_RST              __REG(TARGET_CPU, 0, 1, 824, 0, 1, 4, 0, 0, 1, 4)

#define CPU_ULPI_RST_ULPI_RST                    BIT(0)
#define CPU_ULPI_RST_ULPI_RST_SET(x)\
	FIELD_PREP(CPU_ULPI_RST_ULPI_RST, x)
#define CPU_ULPI_RST_ULPI_RST_GET(x)\
	FIELD_GET(CPU_ULPI_RST_ULPI_RST, x)
...
#define QSYS_RED_PROFILE_WM_RED_LOW              GENMASK(9, 5)
...
#define QSYS_RED_PROFILE_WM_RED_HIGH             GENMASK(4, 0)
...
#define QSYS_RES_CFG_WM_HIGH                     GENMASK(5, 0)
...
#define QSYS_RES_STAT_INUSE                      GENMASK(17, 9)
...
#define QSYS_RES_STAT_MAXUSE                     GENMASK(8, 0)
...
#define QSYS_TAS_CFG_CTRL_LIST_NUM_MAX           GENMASK(23, 19)
...
#define QSYS_TAS_CFG_CTRL_LIST_NUM               GENMASK(18, 14)
...
#define QSYS_TAS_CFG_CTRL_ALWAYS_GB_SCH_Q        BIT(13)
...
#define QSYS_TAS_CFG_CTRL_GCL_ENTRY_NUM          GENMASK(12, 5)
...
#define QSYS_TAS_LIST_CFG_LIST_BASE_ADDR         GENMASK(7, 0)
...
#define QSYS_TAS_LIST_PTR_STATE_CUR_PTR          GENMASK(7, 0)
...
#define QSYS_TAS_GCL_CT_CFG2_PORT_PROFILE        GENMASK(11, 8)
...
#define QSYS_TAS_GCL_CT_CFG2_NEXT_GCL            GENMASK(7, 0)
...
/*      SUNRISE_TOP:SUNRISE_CFG:GMII_CFG */
#define SUNRISE_TOP_GMII_CFG(r)   __REG(TARGET_SUNRISE_TOP, 0, 1, 4, 0, 1, 16, 0, r, 4, 4)

#define SUNRISE_TOP_GMII_CFG_GTX_CLK_ENA         BIT(0)
#define SUNRISE_TOP_GMII_CFG_GTX_CLK_ENA_SET(x)\
	FIELD_PREP(SUNRISE_TOP_GMII_CFG_GTX_CLK_ENA, x)
#define SUNRISE_TOP_GMII_CFG_GTX_CLK_ENA_GET(x)\
	FIELD_GET(SUNRISE_TOP_GMII_CFG_GTX_CLK_ENA, x)

/*      SUNRISE_TOP:SERDES_CFG:SERDES_CFG */
#define SUNRISE_TOP_SERDES_CFG(g) __REG(TARGET_SUNRISE_TOP, 0, 1, 20, g, 3, 8, 0, 0, 1, 4)

#define SUNRISE_TOP_SERDES_CFG_USERCLK_TX_RESET  BIT(10)
#define SUNRISE_TOP_SERDES_CFG_USERCLK_TX_RESET_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_USERCLK_TX_RESET, x)
#define SUNRISE_TOP_SERDES_CFG_USERCLK_TX_RESET_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_USERCLK_TX_RESET, x)

#define SUNRISE_TOP_SERDES_CFG_USERCLK_RX_RESET  BIT(9)
#define SUNRISE_TOP_SERDES_CFG_USERCLK_RX_RESET_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_USERCLK_RX_RESET, x)
#define SUNRISE_TOP_SERDES_CFG_USERCLK_RX_RESET_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_USERCLK_RX_RESET, x)

#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_RESET BIT(8)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_RESET_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_RESET, x)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_RESET_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_RESET, x)

#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_START_USER BIT(7)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_START_USER_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_START_USER, x)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_START_USER_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_TX_START_USER, x)

#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_RESET BIT(6)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_RESET_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_RESET, x)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_RESET_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_RESET, x)

#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_START_USER BIT(5)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_START_USER_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_START_USER, x)
#define SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_START_USER_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_BUFFBYPASS_RX_START_USER, x)

#define SUNRISE_TOP_SERDES_CFG_RESET_ALL         BIT(4)
#define SUNRISE_TOP_SERDES_CFG_RESET_ALL_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_RESET_ALL, x)
#define SUNRISE_TOP_SERDES_CFG_RESET_ALL_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_RESET_ALL, x)

#define SUNRISE_TOP_SERDES_CFG_RESET_TX_PLL_AND_DATAPATH BIT(3)
#define SUNRISE_TOP_SERDES_CFG_RESET_TX_PLL_AND_DATAPATH_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_RESET_TX_PLL_AND_DATAPATH, x)
#define SUNRISE_TOP_SERDES_CFG_RESET_TX_PLL_AND_DATAPATH_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_RESET_TX_PLL_AND_DATAPATH, x)

#define SUNRISE_TOP_SERDES_CFG_RESET_TX_DATAPATH BIT(2)
#define SUNRISE_TOP_SERDES_CFG_RESET_TX_DATAPATH_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_RESET_TX_DATAPATH, x)
#define SUNRISE_TOP_SERDES_CFG_RESET_TX_DATAPATH_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_RESET_TX_DATAPATH, x)

#define SUNRISE_TOP_SERDES_CFG_RESET_RX_PLL_AND_DATAPATH BIT(1)
#define SUNRISE_TOP_SERDES_CFG_RESET_RX_PLL_AND_DATAPATH_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_RESET_RX_PLL_AND_DATAPATH, x)
#define SUNRISE_TOP_SERDES_CFG_RESET_RX_PLL_AND_DATAPATH_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_RESET_RX_PLL_AND_DATAPATH, x)

#define SUNRISE_TOP_SERDES_CFG_RESET_RX_DATAPATH BIT(0)
#define SUNRISE_TOP_SERDES_CFG_RESET_RX_DATAPATH_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_CFG_RESET_RX_DATAPATH, x)
#define SUNRISE_TOP_SERDES_CFG_RESET_RX_DATAPATH_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_CFG_RESET_RX_DATAPATH, x)

/*      SUNRISE_TOP:SERDES_CFG:SERDES_STAT */
#define SUNRISE_TOP_SERDES_STAT(g) __REG(TARGET_SUNRISE_TOP, 0, 1, 20, g, 3, 8, 4, 0, 1, 4)

#define SUNRISE_TOP_SERDES_STAT_USERCLK_RX_ACTIVE BIT(12)
#define SUNRISE_TOP_SERDES_STAT_USERCLK_RX_ACTIVE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_USERCLK_RX_ACTIVE, x)
#define SUNRISE_TOP_SERDES_STAT_USERCLK_RX_ACTIVE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_USERCLK_RX_ACTIVE, x)

#define SUNRISE_TOP_SERDES_STAT_USERCLK_TX_ACTIVE BIT(11)
#define SUNRISE_TOP_SERDES_STAT_USERCLK_TX_ACTIVE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_USERCLK_TX_ACTIVE, x)
#define SUNRISE_TOP_SERDES_STAT_USERCLK_TX_ACTIVE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_USERCLK_TX_ACTIVE, x)

#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_DONE BIT(10)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_DONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_DONE, x)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_DONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_DONE, x)

#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_ERROR BIT(9)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_ERROR_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_ERROR, x)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_ERROR_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_RX_ERROR, x)

#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_DONE BIT(8)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_DONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_DONE, x)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_DONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_DONE, x)

#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_ERROR BIT(7)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_ERROR_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_ERROR, x)
#define SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_ERROR_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_BUFFBYPASS_TX_ERROR, x)

#define SUNRISE_TOP_SERDES_STAT_RESET_RX_CDR_STABLE BIT(6)
#define SUNRISE_TOP_SERDES_STAT_RESET_RX_CDR_STABLE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_RESET_RX_CDR_STABLE, x)
#define SUNRISE_TOP_SERDES_STAT_RESET_RX_CDR_STABLE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_RESET_RX_CDR_STABLE, x)

#define SUNRISE_TOP_SERDES_STAT_RESET_RX_DONE    BIT(5)
#define SUNRISE_TOP_SERDES_STAT_RESET_RX_DONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_RESET_RX_DONE, x)
#define SUNRISE_TOP_SERDES_STAT_RESET_RX_DONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_RESET_RX_DONE, x)

#define SUNRISE_TOP_SERDES_STAT_RESET_TX_DONE    BIT(4)
#define SUNRISE_TOP_SERDES_STAT_RESET_TX_DONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_RESET_TX_DONE, x)
#define SUNRISE_TOP_SERDES_STAT_RESET_TX_DONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_RESET_TX_DONE, x)

#define SUNRISE_TOP_SERDES_STAT_GTPOWERGOOD      BIT(3)
#define SUNRISE_TOP_SERDES_STAT_GTPOWERGOOD_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_GTPOWERGOOD, x)
#define SUNRISE_TOP_SERDES_STAT_GTPOWERGOOD_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_GTPOWERGOOD, x)

#define SUNRISE_TOP_SERDES_STAT_RXPMARESETDONE   BIT(2)
#define SUNRISE_TOP_SERDES_STAT_RXPMARESETDONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_RXPMARESETDONE, x)
#define SUNRISE_TOP_SERDES_STAT_RXPMARESETDONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_RXPMARESETDONE, x)

#define SUNRISE_TOP_SERDES_STAT_TXPMARESETDONE   BIT(1)
#define SUNRISE_TOP_SERDES_STAT_TXPMARESETDONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_TXPMARESETDONE, x)
#define SUNRISE_TOP_SERDES_STAT_TXPMARESETDONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_TXPMARESETDONE, x)

#define SUNRISE_TOP_SERDES_STAT_TXPRGDIVRESETDONE BIT(0)
#define SUNRISE_TOP_SERDES_STAT_TXPRGDIVRESETDONE_SET(x)\
	FIELD_PREP(SUNRISE_TOP_SERDES_STAT_TXPRGDIVRESETDONE, x)
#define SUNRISE_TOP_SERDES_STAT_TXPRGDIVRESETDONE_GET(x)\
	FIELD_GET(SUNRISE_TOP_SERDES_STAT_TXPRGDIVRESETDONE, x)
...
#define SYS_PAUSE_CFG_PAUSE_START                GENMASK(12, 7)
...
#define SYS_PAUSE_CFG_PAUSE_STOP                 GENMASK(6, 1)
...
#define SYS_PAUSE_TOT_CFG_PAUSE_TOT_START        GENMASK(11, 6)
...
#define SYS_PAUSE_TOT_CFG_PAUSE_TOT_STOP         GENMASK(5, 0)
...
#define SYS_ATOP_ATOP                            GENMASK(5, 0)
...
#define SYS_ATOP_TOT_CFG_ATOP_TOT                GENMASK(5, 0)
