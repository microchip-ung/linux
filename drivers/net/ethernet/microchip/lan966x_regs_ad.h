...
/* This file is autogenerated by cml-utils 2022-09-04 20:59:57 +0200.
 * Commit ID: 735fe7798db070f1f48bc03571982ff954299810 (dirty)
 */

#ifndef _LAN966X_REGS_AD_H_
#define _LAN966X_REGS_AD_H_
...
#define GCB_SOFT_RST              __REG(TARGET_GCB, 0, 1, 0, 0, 1, 12, 4, 0, 1, 4)

#define GCB_SOFT_RST_SOFT_SWC_RST                BIT(0)
...
#define GCB_BUILDID               __REG(TARGET_GCB, 0, 1, 0, 0, 1, 12, 8, 0, 1, 4)

/*      DEVCPU_GCB:GPIO:GPIO_OUT_SET */
#define GCB_GPIO_OUT_SET(r)       __REG(TARGET_GCB, 0, 1, 12, 0, 1, 256, 0, r, 8, 4)

#define GCB_GPIO_OUT_SET_G_OUT_SET               GENMASK(5, 0)
#define GCB_GPIO_OUT_SET_G_OUT_SET_SET(x)\
	FIELD_PREP(GCB_GPIO_OUT_SET_G_OUT_SET, x)
#define GCB_GPIO_OUT_SET_G_OUT_SET_GET(x)\
	FIELD_GET(GCB_GPIO_OUT_SET_G_OUT_SET, x)

/*      DEVCPU_GCB:GPIO:GPIO_OUT_CLR */
#define GCB_GPIO_OUT_CLR(r)       __REG(TARGET_GCB, 0, 1, 12, 0, 1, 256, 32, r, 8, 4)

#define GCB_GPIO_OUT_CLR_G_OUT_CLR               GENMASK(5, 0)
#define GCB_GPIO_OUT_CLR_G_OUT_CLR_SET(x)\
	FIELD_PREP(GCB_GPIO_OUT_CLR_G_OUT_CLR, x)
#define GCB_GPIO_OUT_CLR_G_OUT_CLR_GET(x)\
	FIELD_GET(GCB_GPIO_OUT_CLR_G_OUT_CLR, x)

/*      DEVCPU_GCB:GPIO:GPIO_OUT */
#define GCB_GPIO_OUT(r)           __REG(TARGET_GCB, 0, 1, 12, 0, 1, 256, 64, r, 8, 4)

#define GCB_GPIO_OUT_G_OUT                       GENMASK(5, 0)
#define GCB_GPIO_OUT_G_OUT_SET(x)\
	FIELD_PREP(GCB_GPIO_OUT_G_OUT, x)
#define GCB_GPIO_OUT_G_OUT_GET(x)\
	FIELD_GET(GCB_GPIO_OUT_G_OUT, x)
...
#define ORG_SEMA_CFG              __REG(TARGET_ORG, 0, 1, 0, 0, 1, 72, 36, 0, 1, 4)
...
/*      DEVCPU_ORG:ORG:SEMA */
#define ORG_SEMA(r)               __REG(TARGET_ORG, 0, 1, 0, 0, 1, 72, 40, r, 8, 4)
