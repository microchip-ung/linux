...
enum vcap_keyfield_set {
	...
	VCAP_KFS_5TUPLE_IP4,        /* lan966x is1 X2, lan9645x is1 X2 */
	VCAP_KFS_5TUPLE_IP6,        /* lan966x is1 X4, lan9645x is1 X4 */
	VCAP_KFS_7TUPLE,            /* lan966x is1 X4, lan9645x is1 X4 */
	VCAP_KFS_ARP,               /* sparx5 is2 X6, sparx5 es2 X6, lan966x is2 X2, lan969x is2 X6, lan969x es2 X6, lan9645x is2 X2 */
	VCAP_KFS_DBL_IP4,           /* sparx5 lpm X2, lan969x lpm X2 */
	VCAP_KFS_DBL_IP6,           /* sparx5 lpm X6, lan969x lpm X6 */
	VCAP_KFS_DBL_VID,           /* lan966x is1 X1, lan9645x is1 X1 */
	VCAP_KFS_DMAC_VID,          /* lan966x is1 X1, lan9645x is1 X1 */
	VCAP_KFS_ETAG,              /* sparx5 is0 X2 */
	VCAP_KFS_IP4_OTHER,         /* sparx5 is2 X6, sparx5 es2 X6, lan966x is2 X2, lan969x is2 X6, lan969x es2 X6, lan9645x is2 X2 */
	VCAP_KFS_IP4_TCP_UDP,       /* sparx5 is2 X6, sparx5 es2 X6, lan966x is2 X2, lan969x is2 X6, lan969x es2 X6, lan9645x is2 X2 */
	VCAP_KFS_IP4_VID,           /* sparx5 es2 X3 */
	VCAP_KFS_IP6PFX_ID,         /* sparx5 lpm X2, lan969x lpm X2 */
	VCAP_KFS_IP6_OTHER,         /* lan966x is2 X4, lan9645x is2 X4 */
	VCAP_KFS_IP6_STD,           /* sparx5 is2 X6, sparx5 es2 X6, lan966x is2 X2, lan969x is2 X6, lan969x es2 X6, lan9645x is2 X2 */
	VCAP_KFS_IP6_TCP_UDP,       /* lan966x is2 X4, lan9645x is2 X4 */
	...
	VCAP_KFS_MAC_ETYPE,         /* sparx5 is2 X6, sparx5 es2 X6, lan966x is2 X2, lan969x is2 X6, lan969x es2 X6, lan9645x is2 X2 */
	VCAP_KFS_MAC_LLC,           /* lan966x is2 X2, lan9645x is2 X2 */
	VCAP_KFS_MAC_SNAP,          /* lan966x is2 X2, lan9645x is2 X2 */
	VCAP_KFS_NORMAL,            /* lan966x is1 X2, lan9645x is1 X2 */
	VCAP_KFS_NORMAL_5TUPLE_IP4,  /* sparx5 is0 X6, lan969x is0 X6 */
	VCAP_KFS_NORMAL_7TUPLE,     /* sparx5 is0 X12, lan969x is0 X12 */
	VCAP_KFS_NORMAL_DMAC,       /* lan966x is1 X2 */
	VCAP_KFS_NORMAL_IP6,        /* lan966x is1 X4, lan9645x is1 X4 */
	VCAP_KFS_NORMAL_IP6_DMAC,   /* lan966x is1 X4 */
	VCAP_KFS_OAM,               /* lan966x is2 X2, lan9645x is2 X2 */
	VCAP_KFS_PURE_5TUPLE_IP4,   /* sparx5 is0 X3 */
	VCAP_KFS_RT,                /* lan966x is1 X1 */
	VCAP_KFS_SGL_IP4,           /* sparx5 lpm X1, lan969x lpm X1 */
	VCAP_KFS_SGL_IP6,           /* sparx5 lpm X3, lan969x lpm X3 */
	VCAP_KFS_SMAC_SIP4,         /* lan966x is2 X1, lan9645x is2 X1 */
	VCAP_KFS_SMAC_SIP6,         /* lan966x is2 X2, lan9645x is2 X2 */
	VCAP_KFS_VID,               /* lan966x es0 X1, lan9645x es0 X1 */
};
 ...
 *   0xf1c1)
 * VCAP_KF_8021Q_DEI0: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x:
 *   is1
 *   First DEI in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_DEI1: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x:
 *   is1
 *   Second DEI in multiple vlan tags (inner tag)
 * VCAP_KF_8021Q_DEI2: W1, sparx5: is0, lan969x: is0
 *   Third DEI in multiple vlan tags (not always available)
 * VCAP_KF_8021Q_DEI_CLS: W1, sparx5: is2/es2, lan966x: is2/es0, lan969x:
 *   is2/es2, lan9645x: is2/es0
 *   Classified DEI
 * VCAP_KF_8021Q_PCP0: W3, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x:
 *   is1
 *   First PCP in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_PCP1: W3, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x:
 *   is1
 *   Second PCP in multiple vlan tags (inner tag)
 * VCAP_KF_8021Q_PCP2: W3, sparx5: is0, lan969x: is0
 *   Third PCP in multiple vlan tags (not always available)
 * VCAP_KF_8021Q_PCP_CLS: W3, sparx5: is2/es2, lan966x: is2/es0, lan969x:
 *   is2/es2, lan9645x: is2/es0
 *   Classified PCP
 * VCAP_KF_8021Q_TPID: W3, sparx5: es0, lan969x: es0
 *   TPID for outer tag: 0: Customer TPID 1: Service TPID (88A8 or programmable)
 * VCAP_KF_8021Q_TPID0: sparx5 is0 W3, lan966x is1 W1, lan969x is0 W3, lan9645x
 *   is1 W1
 *   First TPIC in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_TPID1: sparx5 is0 W3, lan966x is1 W1, lan969x is0 W3, lan9645x
 *   is1 W1
 *   Second TPID in multiple vlan tags (inner tag)
 * VCAP_KF_8021Q_TPID2: W3, sparx5: is0, lan969x: is0
 *   Third TPID in multiple vlan tags (not always available)
 * VCAP_KF_8021Q_VID0: W12, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x:
 *   is1
 *   First VID in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_VID1: W12, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x:
 *   is1
 *   Second VID in multiple vlan tags (inner tag)
 * VCAP_KF_8021Q_VID2: W12, sparx5: is0, lan969x: is0
 *   Third VID in multiple vlan tags (not always available)
 * VCAP_KF_8021Q_VID_CLS: sparx5 is2 W13, sparx5 es0 W13, sparx5 es2 W13,
 *   lan966x is2 W12, lan966x es0 W12, lan969x is2 W13, lan969x es0 W13, lan969x
 *   es2 W13, lan9645x is2 W12, lan9645x es0 W12
 *   Classified VID
 * VCAP_KF_8021Q_VLAN_DBL_TAGGED_IS: W1, lan966x: is1, lan9645x: is1
 *   Set if frame has two or more Q-tags. Independent of port VLAN awareness
 * VCAP_KF_8021Q_VLAN_TAGGED_IS: W1, sparx5: is2/es2, lan966x: is1/is2, lan969x:
 *   is2/es2, lan9645x: is1/is2
 ...
 * VCAP_KF_AFFIX: W10, sparx5: lpm, lan969x: lpm
 ...
 *   is2/es2, lan9645x: is2
 *   Set if hardware address is Ethernet
 * VCAP_KF_ARP_LEN_OK_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Set if hardware address length = 6 (Ethernet) and IP address length = 4 (IP).
 * VCAP_KF_ARP_OPCODE: W2, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   ARP opcode
 * VCAP_KF_ARP_OPCODE_UNKNOWN_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Set if not one of the codes defined in VCAP_KF_ARP_OPCODE
 * VCAP_KF_ARP_PROTO_SPACE_OK_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Set if protocol address space is 0x0800
 * VCAP_KF_ARP_SENDER_MATCH_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Sender Hardware Address = SMAC (ARP)
 * VCAP_KF_ARP_TGT_MATCH_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Target Hardware Address = SMAC (RARP)
 * VCAP_KF_COSID_CLS: W3, sparx5: es0/es2, lan969x: es0/es2
 *   Class of service
 * VCAP_KF_DST_FLAG: W1, sparx5: lpm, lan969x: lpm
 ...
 * VCAP_KF_ETYPE: W16, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Ethernet type
 * VCAP_KF_ETYPE_LEN_IS: W1, sparx5: is0/is2/es2, lan966x: is1, lan969x:
 *   is0/is2/es2, lan9645x: is1
 *   Set if frame has EtherType >= 0x600
 * VCAP_KF_HOST_MATCH: W1, lan966x: is2, lan9645x: is2
 ...
 *   is2 W4, lan966x es0 W4, lan969x es2 W7, lan9645x is2 W4, lan9645x es0 W4
 ...
 *   lan966x is1 W9, lan966x is2 W9, lan969x is0 W65, lan969x is2 W32, lan969x is2
 *   W65, lan9645x is1 W10, lan9645x is2 W10
 *   Ingress port mask, one bit per port/erleg
 * VCAP_KF_IF_IGR_PORT_MASK_L3: W1, sparx5: is2, lan969x: is2
 *   If set, IF_IGR_PORT_MASK, IF_IGR_PORT_MASK_RNG, and IF_IGR_PORT_MASK_SEL are
 *   used to specify L3 interfaces
 * VCAP_KF_IF_IGR_PORT_MASK_RNG: W4, sparx5: is2, lan969x: is2
 *   Range selector for IF_IGR_PORT_MASK.  Specifies which group of 32 ports are
 *   available in IF_IGR_PORT_MASK
 * VCAP_KF_IF_IGR_PORT_MASK_SEL: W2, sparx5: is0/is2, lan969x: is0/is2
 ...
 * VCAP_KF_IF_IGR_PORT_SEL: W1, sparx5: es2, lan969x: es2
 *   Selector for IF_IGR_PORT: physical port number or ERLEG
 * VCAP_KF_IP4_DIP: W32, sparx5: lpm, lan969x: lpm
 *   IPv4 destination address. Used for IPv4 MC routing.
 * VCAP_KF_IP4_IS: W1, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Set if frame has EtherType = 0x800 and IP version = 4
 * VCAP_KF_IP4_SIP: W32, sparx5: lpm, lan969x: lpm
 *   IPv4 source address. Used for IPv4 MC routing.
 * VCAP_KF_IP4_XIP: W32, sparx5: lpm, lan969x: lpm
 *   IPv4 address. Used for IPv4 UC routing as well as IPv4 Source/Destination
 *   Guard.
 * VCAP_KF_IP6PFX_ID: sparx5 lpm W9, lan969x lpm W8
 *   IP6PFX_ID from VCAP IP6PFX_ID lookup. Used for IPv6 UC Routing as well as
 *   IPv6 Source/Destination Guard. This key only applies when VCAP IP6PFX is also
 *   used.
 * VCAP_KF_IP6_DIP: W128, sparx5: lpm, lan969x: lpm
 *   IPv6 destination address. Used for IPv6 MC routing.
 * VCAP_KF_IP6_SIP: W128, sparx5: lpm, lan969x: lpm
 *   IPv6 source address. Used for IPv6 MC routing.
 * VCAP_KF_IP6_XIP: W128, sparx5: lpm, lan969x: lpm
 *   IPv6 address. Used for IPv6 UC routing as well as IPv6 Source/Destination
 *   Guard.
 * VCAP_KF_IP6_XIP_0: W32, sparx5: lpm, lan969x: lpm
 *   First word of ip6_xip field. IP6PFX_ID=0: Most significant 64 bits of IPv6
 *   address. IP6PFX_ID>0: Least significant 64 bits of IPv6 address.
 * VCAP_KF_IP6_XIP_1: W32, sparx5: lpm, lan969x: lpm
 *   Second word of ip6_xip field.
 * VCAP_KF_IP_MC_IS: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 ...
 * VCAP_KF_IP_PAYLOAD_5TUPLE: W32, sparx5: is0, lan966x: is1, lan969x: is0,
 *   lan9645x: is1
 *   Payload bytes after IP header
 * VCAP_KF_IP_PAYLOAD_S1_IP6: W112, lan966x: is1, lan9645x: is1
 *   Payload after IPv6 header
 * VCAP_KF_IP_SNAP_IS: W1, sparx5: is0, lan966x: is1, lan969x: is0/is2/es2,
 *   lan9645x: is1
 *   Set if frame is IPv4, IPv6, or SNAP frame
 * VCAP_KF_ISDX_CLS: sparx5 is2 W12, sparx5 es0 W12, sparx5 es2 W12, lan966x es0
 *   W8, lan969x is2 W10, lan969x es0 W10, lan969x es2 W10, lan9645x es0 W7
 *   Classified ISDX
 * VCAP_KF_ISDX_GT0_IS: W1, sparx5: is2/es0/es2, lan966x: is2/es0, lan969x:
 *   is2/es0/es2, lan9645x: is2/es0
 *   Set if classified ISDX > 0
 * VCAP_KF_L2_BC_IS: W1, sparx5: is0/is2/es2, lan966x: is1/is2/es0, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2/es0
 *   Set if frame’s destination MAC address is the broadcast address
 *   (FF-FF-FF-FF-FF-FF).
 * VCAP_KF_L2_DMAC: W48, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Destination MAC address
 * VCAP_KF_L2_FRM_TYPE: W4, lan966x: is2, lan9645x: is2
 *   Frame subtype for specific EtherTypes (MRP, DLR)
 * VCAP_KF_L2_FWD_IS: W1, sparx5: is2, lan969x: is2
 *   Set if the frame is allowed to be forwarded to front ports
 * VCAP_KF_L2_LLC: W40, lan966x: is2, lan9645x: is2
 ...
 * VCAP_KF_L2_MC_IS: W1, sparx5: is0/is2/es2, lan966x: is1/is2/es0, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2/es0
 *   Set if frame’s destination MAC address is a multicast address (bit 40 = 1).
 * VCAP_KF_L2_PAYLOAD0: W16, lan966x: is2, lan9645x: is2
 *   Payload bytes 0-1 after the frame’s EtherType
 * VCAP_KF_L2_PAYLOAD1: W8, lan966x: is2, lan9645x: is2
 *   Payload byte 4 after the frame’s EtherType. This is specifically for PTP
 *   frames.
 * VCAP_KF_L2_PAYLOAD2: W3, lan966x: is2, lan9645x: is2
 *   Bits 7, 2, and 1 from payload byte 6 after the frame’s EtherType. This is
 *   specifically for PTP frames.
 * VCAP_KF_L2_PAYLOAD_ETYPE: W64, sparx5: is2/es2, lan969x: is2/es2
 *   Byte 0-7 of L2 payload after Type/Len field and overloading for OAM
 * VCAP_KF_L2_SMAC: W48, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Source MAC address
 * VCAP_KF_L2_SNAP: W40, lan966x: is2, lan9645x: is2
 *   SNAP header after LLC header (AA-AA-03)
 * VCAP_KF_L3_DIP_EQ_SIP_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Set if Src IP matches Dst IP address
 * VCAP_KF_L3_DPL_CLS: W1, sparx5: es0/es2, lan966x: es0, lan969x: es0/es2,
 *   lan9645x: es0
 *   The frames drop precedence level
 * VCAP_KF_L3_DSCP: W6, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   Frame’s DSCP value
 * VCAP_KF_L3_DST_IS: W1, sparx5: is2, lan969x: is2
 *   Set if lookup is done for egress router leg
 * VCAP_KF_L3_FRAGMENT: W1, lan966x: is1/is2, lan9645x: is1/is2
 *   Set if IPv4 frame is fragmented
 * VCAP_KF_L3_FRAGMENT_TYPE: W2, sparx5: is0/is2/es2, lan969x: is0/is2/es2
 *   L3 Fragmentation type (none, initial, suspicious, valid follow up)
 * VCAP_KF_L3_FRAG_INVLD_L4_LEN: W1, sparx5: is0/is2, lan969x: is0/is2
 *   Set if frame's L4 length is less than ANA_CL:COMMON:CLM_FRAGMENT_CFG.L4_MIN_L
 *   EN
 * VCAP_KF_L3_FRAG_OFS_GT0: W1, lan966x: is1/is2, lan9645x: is1/is2
 *   Set if IPv4 frame is fragmented and it is not the first fragment
 * VCAP_KF_L3_IP4_DIP: W32, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Destination IPv4 Address
 * VCAP_KF_L3_IP4_SIP: W32, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Source IPv4 Address
 * VCAP_KF_L3_IP6_DIP: sparx5 is0 W128, sparx5 is2 W128, sparx5 es2 W128,
 *   lan966x is1 W64, lan966x is1 W128, lan966x is2 W128, lan969x is0 W128,
 *   lan969x is2 W128, lan969x es2 W128, lan9645x is1 W64, lan9645x is1 W128,
 *   lan9645x is2 W128
 *   Sparx5: Full IPv6 DIP, LAN966x: Either Full IPv6 DIP or a subset depending on
 *   frame type
 * VCAP_KF_L3_IP6_DIP_MSB: W16, lan966x: is1, lan9645x: is1
 *   MS 16bits of IPv6 DIP
 * VCAP_KF_L3_IP6_SIP: sparx5 is0 W128, sparx5 is2 W128, sparx5 es2 W128,
 *   lan966x is1 W128, lan966x is1 W64, lan966x is2 W128, lan969x is0 W128,
 *   lan969x is2 W128, lan969x es2 W128, lan9645x is1 W128, lan9645x is1 W64,
 *   lan9645x is2 W128
 *   Sparx5: Full IPv6 SIP, LAN966x: Either Full IPv6 SIP or a subset depending on
 *   frame type
 * VCAP_KF_L3_IP6_SIP_MSB: W16, lan966x: is1, lan9645x: is1
 *   MS 16bits of IPv6 DIP
 * VCAP_KF_L3_IP_PROTO: W8, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   IPv4 frames: IP protocol. IPv6 frames: Next header, same as for IPV4
 * VCAP_KF_L3_OPTIONS_IS: W1, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Set if IPv4 frame contains options (IP len > 5)
 * VCAP_KF_L3_PAYLOAD: sparx5 is2 W96, sparx5 is2 W40, sparx5 es2 W96, sparx5
 *   es2 W40, lan966x is2 W56, lan969x is2 W96, lan969x is2 W40, lan969x es2 W96,
 *   lan969x es2 W40, lan9645x is2 W56
 ...
 * VCAP_KF_L3_RT_IS: W1, sparx5: is2/es2, lan969x: is2/es2
 *   Set if frame has hit a router leg
 * VCAP_KF_L3_TOS: W8, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Sparx5: Frame's IPv4/IPv6 DSCP and ECN fields, LAN966x: IP TOS field
 * VCAP_KF_L3_TTL_GT0: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Set if IPv4 TTL / IPv6 hop limit is greater than 0
 * VCAP_KF_L4_1588_DOM: W8, lan966x: is2, lan9645x: is2
 *   PTP over UDP: domainNumber
 * VCAP_KF_L4_1588_VER: W4, lan966x: is2, lan9645x: is2
 *   PTP over UDP: version
 * VCAP_KF_L4_ACK: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Sparx5 and LAN966x: TCP flag ACK, LAN966x only: PTP over UDP: flagField bit 2
 *   (unicastFlag)
 * VCAP_KF_L4_DPORT: W16, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 ...
 * VCAP_KF_L4_FIN: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   TCP flag FIN, LAN966x: TCP flag FIN, and for PTP over UDP: messageType bit 1
 * VCAP_KF_L4_PAYLOAD: W64, sparx5: is2/es2, lan969x: is2/es2
 ...
 *   TCP/UDP IPv4 frames
 * VCAP_KF_L4_PSH: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 ...
 *   W8, lan966x is2 W8, lan969x is0 W8, lan969x is2 W16, lan969x es2 W16,
 *   lan9645x is1 W8, lan9645x is2 W8
 ...
 *   outer VID, inner VID)
 * VCAP_KF_L4_RST: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Sparx5: TCP flag RST , LAN966x: TCP: TCP flag RST. PTP over UDP: messageType
 *   bit 3
 * VCAP_KF_L4_SEQUENCE_EQ0_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Set if TCP sequence number is 0, LAN966x: Overlayed with PTP over UDP:
 *   messageType bit 0
 * VCAP_KF_L4_SPORT: W16, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   TCP/UDP source port
 * VCAP_KF_L4_SPORT_EQ_DPORT_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Set if UDP or TCP source port equals UDP or TCP destination port
 * VCAP_KF_L4_SYN: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Sparx5: TCP flag SYN, LAN966x: TCP: TCP flag SYN. PTP over UDP: messageType
 *   bit 2
 * VCAP_KF_L4_URG: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Sparx5: TCP flag URG, LAN966x: TCP: TCP flag URG. PTP over UDP: flagField bit
 *   7 (reserved)
 * VCAP_KF_LOOKUP_FIRST_IS: W1, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is2
 *   Selects between entries relevant for first and second lookup. Set for first
 *   lookup, cleared for second lookup.
 * VCAP_KF_LOOKUP_GEN_IDX: sparx5 is0 W12, lan969x is0 W10
 *   Generic index - for chaining CLM instances
 * VCAP_KF_LOOKUP_GEN_IDX_SEL: W2, sparx5: is0, lan969x: is0
 *   Select the mode of the Generic Index
 * VCAP_KF_LOOKUP_INDEX: W2, lan966x: is1, lan9645x: is1
 *   0: First lookup, 1: Second lookup, 2: Third lookup, Similar to VCAP_KF_FIRST
 *   but with extra info
 * VCAP_KF_LOOKUP_PAG: W8, sparx5: is2, lan966x: is2, lan969x: is2, lan9645x:
 *   is2
 ...
 * VCAP_KF_OAM_CCM_CNTS_EQ0: W1, sparx5: is2/es2, lan966x: is2, lan969x:
 *   is2/es2, lan9645x: is2
 *   Dual-ended loss measurement counters in CCM frames are all zero
 * VCAP_KF_OAM_DETECTED: W1, lan966x: is2, lan9645x: is2
 *   This is missing in the datasheet, but present in the OAM keyset in XML
 * VCAP_KF_OAM_FLAGS: W8, lan966x: is2, lan9645x: is2
 *   Frame’s OAM flags
 * VCAP_KF_OAM_MEL_FLAGS: W7, lan966x: is2, lan9645x: is2
 *   Encoding of MD level/MEG level (MEL)
 * VCAP_KF_OAM_MEPID: W16, lan966x: is2, lan9645x: is2
 *   CCM frame’s OAM MEP ID
 * VCAP_KF_OAM_OPCODE: W8, lan966x: is2, lan9645x: is2
 *   Frame’s OAM opcode
 * VCAP_KF_OAM_VER: W5, lan966x: is2, lan9645x: is2
 *   Frame’s OAM version
 * VCAP_KF_OAM_Y1731_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 *   Set if frame’s EtherType = 0x8902
 * VCAP_KF_PDU_TYPE: W4, lan966x: es0, lan9645x: es0
 ...
 * VCAP_KF_R_TAGGED_IS: *** No docstring ***
 * VCAP_KF_TCP_IS: W1, sparx5: is0/is2/es2, lan966x: is1/is2, lan969x:
 *   is0/is2/es2, lan9645x: is1/is2
 *   Set if frame is IPv4 TCP frame (IP protocol = 6) or IPv6 TCP frames (Next
 *   header = 6)
 * VCAP_KF_TCP_UDP_IS: W1, sparx5: is0/is2/es2, lan966x: is1, lan969x:
 *   is0/is2/es2, lan9645x: is1
 ...
 *   lan966x is2 W4, lan966x is2 W2, lan969x is0 W1, lan969x is0 W2, lan969x is2
 *   W4, lan969x is2 W2, lan969x es0 W1, lan969x lpm W1, lan969x es2 W3, lan9645x
 *   is1 W1, lan9645x is1 W2, lan9645x is2 W4, lan9645x is2 W2
...
enum vcap_actionfield_set {
	...
	VCAP_AFS_ARP_ENTRY,         /* sparx5 lpm X1, lan969x lpm X1 */
	VCAP_AFS_ARP_PTR,           /* sparx5 lpm X1, lan969x lpm X1 */
	VCAP_AFS_BASE_TYPE,         /* sparx5 is2 X3, sparx5 es2 X3, lan966x is2 X2, lan969x is2 X3, lan969x es2 X3, lan9645x is2 X2 */
	VCAP_AFS_CLASSIFICATION,    /* sparx5 is0 X2, lan969x is0 X2 */
	VCAP_AFS_CLASS_REDUCED,     /* sparx5 is0 X1, lan969x is0 X1 */
	VCAP_AFS_ES0,               /* sparx5 es0 X1, lan969x es0 X1 */
	VCAP_AFS_FULL,              /* sparx5 is0 X3, lan969x is0 X3 */
	VCAP_AFS_L3MC_PTR,          /* sparx5 lpm X1, lan969x lpm X1 */
	VCAP_AFS_S1,                /* lan966x is1 X1, lan9645x is1 X1 */
	VCAP_AFS_S1_RT,             /* lan966x is1 X1 */
	VCAP_AFS_SMAC_SIP,          /* lan966x is2 X1, lan9645x is2 X1 */
	VCAP_AFS_VID,               /* lan966x es0 X1, lan9645x es0 X1 */
};

/* List of actionfields with description
 *
 * VCAP_AF_ACL_ID: W6, lan966x: is2, lan9645x: is2
 ...
 *   HIT_ME_ONCE set.
 * VCAP_AF_ANA2_TSN_DIS: *** No docstring ***
 * VCAP_AF_ARP_ENA: W1, sparx5: lpm, lan969x: lpm
 *   Enable entry for address resolution usage.
 * VCAP_AF_ARP_PTR: sparx5 lpm W11, lan969x lpm W10
 *   Pointer to entry in ARP Table.
 * VCAP_AF_ARP_PTR_REMAP_ENA: W1, sparx5: lpm, lan969x: lpm
 *   If this bit is set, ARP_PTR is used to point to an entry in the ARP pointer
 *   remap table.
 * VCAP_AF_ARP_VMID: sparx5 lpm W9, lan969x lpm W7
 *   Routing lookup. Egress router leg (EVMID).
 * VCAP_AF_CLS_VID_SEL: W3, sparx5: is0, lan969x: is0
 ...
 * VCAP_AF_CNT_ID: sparx5 is2 W12, sparx5 es2 W11, lan969x is2 W10, lan969x es2
 *   W9
 ...
 * VCAP_AF_COPY_PORT_NUM: sparx5 es2 W7, lan969x es2 W6
 *   QSYS port number when FWD_MODE is redirect or copy
 * VCAP_AF_COPY_QUEUE_NUM: sparx5 es2 W16, lan969x es2 W14
 *   QSYS queue number when FWD_MODE is redirect or copy
 * VCAP_AF_CPU_COPY_ENA: W1, sparx5: is2/es2, lan966x: is1/is2, lan969x:
 *   is2/es2, lan9645x: is2
 ...
 * VCAP_AF_CPU_DIS: *** No docstring ***
 * VCAP_AF_CPU_DIS_MODE: *** No docstring ***
 ...
 * VCAP_AF_CT_SEL: *** No docstring ***
 * VCAP_AF_CUSTOM_ACE_TYPE_ENA: *** No docstring ***
 * VCAP_AF_DEI_A_VAL: W1, sparx5: es0, lan966x: es0, lan969x: es0, lan9645x: es0
 *   DEI used in ES0 tag A. See TAG_A_DEI_SEL.
 * VCAP_AF_DEI_B_VAL: W1, sparx5: es0, lan966x: es0, lan969x: es0, lan9645x: es0
 *   DEI used in ES0 tag B. See TAG_B_DEI_SEL.
 * VCAP_AF_DEI_C_VAL: W1, sparx5: es0, lan969x: es0
 *   DEI used in ES0 tag C. See TAG_C_DEI_SEL.
 * VCAP_AF_DEI_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   If set, use DEI_VAL as classified DEI value. Otherwise, DEI from basic
 *   classification is used
 * VCAP_AF_DEI_VAL: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   See DEI_ENA
 * VCAP_AF_DLR_SEL: *** No docstring ***
 * VCAP_AF_DP_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   If set, use DP_VAL as classified drop precedence level. Otherwise, drop
 *   precedence level from basic classification is used.
 * VCAP_AF_DP_VAL: sparx5 is0 W2, lan966x is1 W1, lan969x is0 W2, lan9645x is1
 *   W1
 *   See DP_ENA.
 * VCAP_AF_DSCP_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   If set, use DSCP_VAL as classified DSCP value. Otherwise, DSCP value from
 *   basic classification is used.
 * VCAP_AF_DSCP_SEL: W3, sparx5: es0, lan969x: es0
 ...
 * VCAP_AF_DSCP_VAL: W6, sparx5: is0/es0, lan966x: is1, lan969x: is0/es0,
 *   lan9645x: is1
 *   See DSCP_ENA.
 * VCAP_AF_DUPL_DISC_DIS: *** No docstring ***
 * VCAP_AF_ECMP_CNT: W4, sparx5: lpm, lan969x: lpm
 *   Number of equal cost, multiple paths routes to DIP.
 * VCAP_AF_ENCAP_ID: sparx5 lpm W10, lan969x lpm W8
 *   Index into REW:ENCAP_IP4 when encapsulating IP packet in IPv4. Disabled when
 *   set to 0.
 * VCAP_AF_ES2_REW_CMD: W3, sparx5: es2, lan969x: es2
 *   Command forwarded to REW: 0: No action. 1: SWAP MAC addresses. 2: Do L2CP
 *   DMAC translation when entering or leaving a tunnel.
 * VCAP_AF_ESDX: sparx5 es0 W13, lan966x es0 W8, lan969x es0 W10, lan9645x es0
 *   W7
 *   Egress counter index. Used to index egress counter set as defined in
 *   REW::STAT_CFG.
 * VCAP_AF_FWD_ENA: *** No docstring ***
 * VCAP_AF_FWD_KILL_ENA: W1, lan966x: is2, lan9645x: is2
 ...
 * VCAP_AF_FWD_MASK: *** No docstring ***
 * VCAP_AF_FWD_MODE: W2, sparx5: es2, lan969x: es2
 *   Forward selector: 0: Forward. 1: Discard. 2: Redirect. 3: Copy.
 * VCAP_AF_FWD_SEL: W2, sparx5: es0, lan966x: is1, lan969x: es0
 *   ES0 Forward selector. 0: No action. 1: Copy to loopback interface. 2:
 *   Redirect to loopback interface. 3: Discard
 * VCAP_AF_HIT_ME_ONCE: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2,
 *   lan9645x: is2
 ...
 * VCAP_AF_HOST_MATCH: W1, lan966x: is2, lan9645x: is2
 ...
 * VCAP_AF_IGNORE_PIPELINE_CTRL: W1, sparx5: is2/es2, lan969x: is2/es2
 ...
 * VCAP_AF_INTR_ENA: W1, sparx5: is2/es2, lan969x: is2/es2
 *   If set, an interrupt is triggered when this rule is hit
 * VCAP_AF_ISDX_ADD_REPLACE_SEL: W1, sparx5: is0, lan969x: is0
 *   Controls the classified ISDX. 0: New ISDX = old ISDX + ISDX_VAL. 1: New ISDX
 *   = ISDX_VAL.
 * VCAP_AF_ISDX_ADD_VAL: lan966x is1 W8, lan9645x is1 W7
 ...
 * VCAP_AF_MAP_KEY: W3, sparx5: is0, lan969x: is0
 ...
 *   otherwise none
 * VCAP_AF_MAP_LOOKUP_SEL: W2, sparx5: is0, lan969x: is0
 ...
 * VCAP_AF_MASK_MODE: sparx5 is0 W3, sparx5 is2 W3, lan966x is2 W2, lan969x is0
 *   W3, lan969x is2 W3, lan9645x is2 W2
 ...
 *   MASK_MODE.
 * VCAP_AF_MATCH_ID: W16, sparx5: is2, lan969x: is2
 ...
 *   IFH.CL_RSLT.
 * VCAP_AF_MATCH_ID_MASK: W16, sparx5: is2, lan969x: is2
 *   Mask used by MATCH_ID.
 * VCAP_AF_MIRROR_ENA: W1, lan966x: is2, lan9645x: is2
 *   Setting this bit to 1 causes frames to be mirrored to the mirror target port
 *   (ANA::MIRRPORPORTS).
 * VCAP_AF_MIRROR_PROBE: W2, sparx5: is2, lan969x: is2
 ...
 * VCAP_AF_MIRROR_PROBE_ID: W2, sparx5: es2, lan969x: es2
 ...
 * VCAP_AF_MRP_SEL: *** No docstring ***
 * VCAP_AF_NXT_IDX: sparx5 is0 W12, lan969x is0 W10
 *   Index used as part of key (field G_IDX) in the next lookup.
 * VCAP_AF_NXT_IDX_CTRL: W3, sparx5: is0, lan969x: is0
 *   Controls the generation of the G_IDX used in the VCAP CLM next lookup
 * VCAP_AF_OAM_MRP_ENA: W1, lan969x: is0
 *   Configure the frame to MRP
 * VCAP_AF_OAM_SEL: *** No docstring ***
 * VCAP_AF_OWN_MAC: *** No docstring ***
 * VCAP_AF_PAG_OVERRIDE_MASK: W8, sparx5: is0, lan966x: is1, lan969x: is0,
 *   lan9645x: is1
 ...
 * VCAP_AF_PAG_VAL: W8, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   See PAG_OVERRIDE_MASK.
 * VCAP_AF_PCP_A_VAL: W3, sparx5: es0, lan966x: es0, lan969x: es0, lan9645x: es0
 *   PCP used in ES0 tag A. See TAG_A_PCP_SEL.
 * VCAP_AF_PCP_B_VAL: W3, sparx5: es0, lan966x: es0, lan969x: es0, lan9645x: es0
 *   PCP used in ES0 tag B. See TAG_B_PCP_SEL.
 * VCAP_AF_PCP_C_VAL: W3, sparx5: es0, lan969x: es0
 *   PCP used in ES0 tag C. See TAG_C_PCP_SEL.
 * VCAP_AF_PCP_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   If set, use PCP_VAL as classified PCP value. Otherwise, PCP from basic
 *   classification is used.
 * VCAP_AF_PCP_VAL: W3, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   See PCP_ENA.
 ...
 *   W9, lan969x is2 W5, lan969x es2 W5, lan9645x is1 W8, lan9645x is2 W8
 *   Selects VCAP policer used when policing frames (POLICE_ENA)
 * VCAP_AF_POLICE_REMARK: W1, sparx5: es2, lan969x: es2
 *   If set, frames exceeding policer rates are marked as yellow but not
 *   discarded.
 * VCAP_AF_POLICE_VCAP_ONLY: W1, lan966x: is2, lan9645x: is2
 ...
 * VCAP_AF_POP_VAL: W2, sparx5: es0, lan969x: es0
 *   Controls popping of Q-tags. The final number of Q-tags popped is calculated
 *   as shown in section 4.28.7.2 VLAN Pop Decision.
 * VCAP_AF_PORT_MASK: sparx5 is0 W65, sparx5 is2 W68, lan966x is2 W8, lan969x
 *   is0 W37, lan969x is2 W37, lan9645x is2 W9
 *   Port mask applied to the forwarding decision based on MASK_MODE.
 * VCAP_AF_PUSH_CUSTOMER_TAG: W2, sparx5: es0, lan969x: es0
 ...
 * VCAP_AF_PUSH_INNER_TAG: W1, sparx5: es0, lan966x: es0, lan969x: es0,
 *   lan9645x: es0
 *   Controls inner tagging. 0: Do not push ES0 tag B as inner tag. 1: Push ES0
 *   tag B as inner tag.
 * VCAP_AF_PUSH_OUTER_TAG: W2, sparx5: es0, lan966x: es0, lan969x: es0,
 *   lan9645x: es0
 ...
 *   A.
 * VCAP_AF_QOS_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   If set, use QOS_VAL as classified QoS class. Otherwise, QoS class from basic
 *   classification is used.
 * VCAP_AF_QOS_VAL: W3, sparx5: is0, lan966x: is1, lan969x: is0, lan9645x: is1
 *   See QOS_ENA.
 * VCAP_AF_REW_OP: W16, lan966x: is2, lan9645x: is2
 *   Rewriter operation command.
 * VCAP_AF_RGID: W3, sparx5: lpm, lan969x: lpm
 *   Route Group ID. Used for SIP RPF check.
 * VCAP_AF_RSDX: sparx5 lpm W12, lan969x lpm W10
 *   Router Leg Service Index for ARP table entry.
 * VCAP_AF_RTE_INB_UPD: *** No docstring ***
 * VCAP_AF_RTP_ID: *** No docstring ***
 * VCAP_AF_RTP_SUBID: *** No docstring ***
 * VCAP_AF_RT_DIS: W1, sparx5: is2, lan969x: is2
 *   If set, routing is disallowed. Only applies when IS_INNER_ACL is 0. See also
 *   IGR_ACL_ENA, EGR_ACL_ENA, and RLEG_STAT_IDX.
 * VCAP_AF_SECUR_MATCH_MAC_ENA: W1, sparx5: lpm, lan969x: lpm
 *   Enable Security MAC check.
 * VCAP_AF_SECUR_MATCH_VMID_ENA: W1, sparx5: lpm, lan969x: lpm
 *   Enable Security VMID check.
 * VCAP_AF_SFID_ENA: *** No docstring ***
 * VCAP_AF_SFID_VAL: *** No docstring ***
 * VCAP_AF_SGID_ENA: *** No docstring ***
 * VCAP_AF_SGID_VAL: *** No docstring ***
 * VCAP_AF_SIP_RPF_ENA: W1, sparx5: lpm, lan969x: lpm
 ...
 * VCAP_AF_TAG_A_PCP_SEL: sparx5 es0 W3, lan966x es0 W2, lan969x es0 W3,
 *   lan9645x es0 W2
 *   Selects PCP for ES0 tag A. 0: Classified PCP. 1: PCP_A_VAL. 2: DP and QoS
 *   mapped to PCP (per port table). 3: QoS class.
 * VCAP_AF_TAG_A_TPID_SEL: sparx5 es0 W3, lan966x es0 W2, lan969x es0 W3,
 *   lan9645x es0 W2
 ...
 *   custom.
 * VCAP_AF_TAG_A_VID_SEL: sparx5 es0 W2, lan966x es0 W1, lan969x es0 W2,
 *   lan9645x es0 W1
 *   Selects VID for ES0 tag A. 0: Classified VID + VID_A_VAL. 1: VID_A_VAL.
 * VCAP_AF_TAG_B_DEI_SEL: sparx5 es0 W3, lan966x es0 W2, lan969x es0 W3,
 *   lan9645x es0 W2
 *   Selects PCP for ES0 tag B. 0: Classified DEI. 1: DEI_B_VAL. 2: DP and QoS
 *   mapped to PCP (per port table). 3: DP.
 * VCAP_AF_TAG_B_PCP_SEL: sparx5 es0 W3, lan966x es0 W2, lan969x es0 W3,
 *   lan9645x es0 W2
 *   Selects PCP for ES0 tag B. 0: Classified PCP. 1: PCP_B_VAL. 2: DP and QoS
 *   mapped to PCP (per port table). 3: QoS class.
 * VCAP_AF_TAG_B_TPID_SEL: sparx5 es0 W3, lan966x es0 W2, lan969x es0 W3,
 *   lan9645x es0 W2
 *   Selects TPID for ES0 tag B. 0: 0x8100. 1: 0x88A8. 2: Custom
 *   (REW:PORT:PORT_VLAN_CFG.PORT_TPID). 3: If IFH.TAG_TYPE = 0 then 0x8100 else
 *   custom.
 * VCAP_AF_TAG_B_VID_SEL: sparx5 es0 W2, lan966x es0 W1, lan969x es0 W2,
 *   lan9645x es0 W1
 *   Selects VID for ES0 tag B. 0: Classified VID + VID_B_VAL. 1: VID_B_VAL.
 * VCAP_AF_TAG_C_DEI_SEL: W3, sparx5: es0, lan969x: es0
 ...
 *   2.
 * VCAP_AF_TAG_C_PCP_SEL: W3, sparx5: es0, lan969x: es0
 ...
 * VCAP_AF_TAG_C_TPID_SEL: W3, sparx5: es0, lan969x: es0
 *   Selects TPID for ES0 tag C. 0: 0x8100. 1: 0x88A8. 2: Custom 1. 3: Custom 2.
 *   4: Custom 3. 5: See TAG_A_TPID_SEL.
 * VCAP_AF_TAG_C_VID_SEL: W2, sparx5: es0, lan969x: es0
 *   Selects VID for ES0 tag C. The resulting VID is termed C-TAG.VID. 0:
 *   Classified VID. 1: VID_C_VAL. 2: IFH.ENCAP.GVID. 3: Reserved.
 * VCAP_AF_TYPE: sparx5 is0 W1, sparx5 lpm W2, lan966x is1 W1, lan969x is0 W1,
 *   lan969x lpm W2, lan9645x is1 W1
 *   Actionset type id - Set by the API
 * VCAP_AF_UNTAG_VID_ENA: W1, sparx5: es0, lan969x: es0
 *   Controls insertion of tag C. Untag or insert mode can be selected. See
 *   PUSH_CUSTOMER_TAG.
 * VCAP_AF_VID_A_VAL: W12, sparx5: es0, lan966x: es0, lan969x: es0, lan9645x:
 *   es0
 *   VID used in ES0 tag A. See TAG_A_VID_SEL.
 * VCAP_AF_VID_B_VAL: W12, sparx5: es0, lan966x: es0, lan969x: es0, lan9645x:
 *   es0
 *   VID used in ES0 tag B. See TAG_B_VID_SEL.
 * VCAP_AF_VID_C_VAL: W12, sparx5: es0, lan969x: es0
 *   VID used in ES0 tag C. See TAG_C_VID_SEL.
 * VCAP_AF_VID_REPLACE_ENA: W1, lan966x: is1, lan9645x: is1
 ...
 *   VID.
 * VCAP_AF_VID_VAL: sparx5 is0 W13, lan966x is1 W12, lan969x is0 W13, lan9645x
 *   is1 W12
 *   New VID Value
 * VCAP_AF_VLAN_POP_CNT: *** No docstring ***
 * VCAP_AF_VLAN_POP_CNT_ENA: *** No docstring ***
 * VCAP_AF_ZERO_DMAC_CPU_QU: W3, sparx5: lpm, lan969x: lpm
