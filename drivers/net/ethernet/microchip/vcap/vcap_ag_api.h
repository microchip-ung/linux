...
/* This file is autogenerated by cml-utils 2024-12-10 15:38:21 +0100.
 ...
 *   0xf1c1)
 * VCAP_KF_8021Q_DEI0: W1, sparx5: is0, lan966x: is1, lan969x: is0
 *   First DEI in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_DEI1: W1, sparx5: is0, lan966x: is1, lan969x: is0
 ...
 *   is2/es2
 *   Classified DEI
 * VCAP_KF_8021Q_PCP0: W3, sparx5: is0, lan966x: is1, lan969x: is0
 *   First PCP in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_PCP1: W3, sparx5: is0, lan966x: is1, lan969x: is0
 ...
 * VCAP_KF_8021Q_TPID0: sparx5 is0 W3, lan966x is1 W1, lan969x is0 W3
 *   First TPIC in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_TPID1: sparx5 is0 W3, lan966x is1 W1, lan969x is0 W3
 ...
 * VCAP_KF_8021Q_VID0: W12, sparx5: is0, lan966x: is1, lan969x: is0
 *   First VID in multiple vlan tags (outer tag or default port tag)
 * VCAP_KF_8021Q_VID1: W12, sparx5: is0, lan966x: is1, lan969x: is0
 ...
 * VCAP_KF_ARP_TGT_MATCH_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2
 ...
 * VCAP_KF_IP_MC_IS: W1, sparx5: is0, lan966x: is1, lan969x: is0
 ...
 *   W8, lan969x is2 W10, lan969x es0 W10, lan969x es2 W10
 *   Classified ISDX
 ...
 * VCAP_KF_L3_DIP_EQ_SIP_IS: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2
 ...
 * VCAP_KF_L3_DSCP: W6, sparx5: is0, lan966x: is1, lan969x: is0
 *   Frame’s DSCP value
 ...
 *   lan969x is2 W128, lan969x es2 W128
 ...
 *   but with extra info
 * VCAP_KF_LOOKUP_PAG: W8, sparx5: is2, lan966x: is2, lan969x: is2
 ...
 * VCAP_KF_OAM_CCM_CNTS_EQ0: W1, sparx5: is2/es2, lan966x: is2, lan969x: is2/es2
 ...
 *   W4, lan969x is2 W2, lan969x es0 W1, lan969x lpm W1, lan969x es2 W3
...
enum vcap_actionfield_set {
	...
	VCAP_AFS_BASE_TYPE,         /* sparx5 is2 X3, sparx5 es2 X3, lan966x is2 X2, lan969x is2 X3, lan969x es2 X3 */
 ...
 * VCAP_AF_DEI_A_VAL: W1, sparx5: es0, lan966x: es0, lan969x: es0
 *   DEI used in ES0 tag A. See TAG_A_DEI_SEL.
 * VCAP_AF_DEI_B_VAL: W1, sparx5: es0, lan966x: es0, lan969x: es0
 ...
 * VCAP_AF_DEI_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0
 *   If set, use DEI_VAL as classified DEI value. Otherwise, DEI from basic
 *   classification is used
 * VCAP_AF_DEI_VAL: W1, sparx5: is0, lan966x: is1, lan969x: is0
 *   See DEI_ENA
 * VCAP_AF_DLR_SEL: *** No docstring ***
 * VCAP_AF_DP_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0
 *   If set, use DP_VAL as classified drop precedence level. Otherwise, drop
 *   precedence level from basic classification is used.
 * VCAP_AF_DP_VAL: sparx5 is0 W2, lan966x is1 W1, lan969x is0 W2
 *   See DP_ENA.
 * VCAP_AF_DSCP_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0
 ...
 * VCAP_AF_ESDX: sparx5 es0 W13, lan966x es0 W8, lan969x es0 W10
 ...
 * VCAP_AF_PAG_VAL: W8, sparx5: is0, lan966x: is1, lan969x: is0
 *   See PAG_OVERRIDE_MASK.
 * VCAP_AF_PCP_A_VAL: W3, sparx5: es0, lan966x: es0, lan969x: es0
 *   PCP used in ES0 tag A. See TAG_A_PCP_SEL.
 * VCAP_AF_PCP_B_VAL: W3, sparx5: es0, lan966x: es0, lan969x: es0
 ...
 * VCAP_AF_PCP_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0
 ...
 *   W9, lan969x is2 W5, lan969x es2 W5
 ...
 *   A.
 * VCAP_AF_QOS_ENA: W1, sparx5: is0, lan966x: is1, lan969x: is0
 *   If set, use QOS_VAL as classified QoS class. Otherwise, QoS class from basic
 *   classification is used.
 * VCAP_AF_QOS_VAL: W3, sparx5: is0, lan966x: is1, lan969x: is0
 *   See QOS_ENA.
 ...
 *   PUSH_CUSTOMER_TAG.
 * VCAP_AF_VID_A_VAL: W12, sparx5: es0, lan966x: es0, lan969x: es0
 *   VID used in ES0 tag A. See TAG_A_VID_SEL.
 * VCAP_AF_VID_B_VAL: W12, sparx5: es0, lan966x: es0, lan969x: es0
 ...
 *   VID.
 * VCAP_AF_VID_VAL: sparx5 is0 W13, lan966x is1 W12, lan969x is0 W13
 *   New VID Value
