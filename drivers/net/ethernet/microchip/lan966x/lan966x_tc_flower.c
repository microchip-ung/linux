...
static int lan966x_tc_flower_handler_ipv6_usage(struct vcap_tc_flower_parse_usage *st)
{
	int err = 0;
...
static int lan966x_tc_flower_handler_ip_usage(struct vcap_tc_flower_parse_usage *st)
{
